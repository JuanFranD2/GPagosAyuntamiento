\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/whatwg-\/url Directory Reference}
\hypertarget{dir_35adf4b3b71004a3a3956f7b7370b2de}{}\label{dir_35adf4b3b71004a3a3956f7b7370b2de}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/whatwg-\/url Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/whatwg-\/url Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md8195}{}\doxysubsection{\texorpdfstring{whatwg-\/url}{whatwg-\/url}}\label{README.md_autotoc_md8195}
whatwg-\/url is a full implementation of the WHATWG \href{https://url.spec.whatwg.org/}{\texttt{URL Standard}}. It can be used standalone, but it also exposes a lot of the internal algorithms that are useful for integrating a \doxylink{class_u_r_l}{URL} parser into a project like \href{https://github.com/jsdom/jsdom}{\texttt{jsdom}}.\hypertarget{README.md_autotoc_md8196}{}\doxysubsection{\texorpdfstring{Specification conformance}{Specification conformance}}\label{README.md_autotoc_md8196}
whatwg-\/url is currently up to date with the \doxylink{class_u_r_l}{URL} spec up to commit \href{https://github.com/whatwg/url/commit/6c782003a2d53b1feecd072d1006eb8f1d65fb2d}{\texttt{6c78200}}.
...
whatwg-\/url does not yet implement any encoding handling beyond UTF-\/8. That is, the {\itshape encoding override} parameter does not exist in our API.\hypertarget{README.md_autotoc_md8197}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md8197}
\hypertarget{README.md_autotoc_md8198}{}\doxysubsubsection{\texorpdfstring{The {\ttfamily URL} and {\ttfamily URLSearch\+Params} classes}{The {\ttfamily URL} and {\ttfamily URLSearch\+Params} classes}}\label{README.md_autotoc_md8198}
The main API is provided by the \href{https://url.spec.whatwg.org/\#url-class}{\texttt{{\ttfamily URL}}} and \href{https://url.spec.whatwg.org/\#interface-urlsearchparams}{\texttt{{\ttfamily URLSearch\+Params}}} exports, which follows the spec\textquotesingle{}s behavior in all ways (including e.\+g. {\ttfamily USVString} conversion). Most consumers of this library will want to use these.\hypertarget{README.md_autotoc_md8199}{}\doxysubsubsection{\texorpdfstring{Low-\/level URL Standard API}{Low-\/level URL Standard API}}\label{README.md_autotoc_md8199}
...
The \doxylink{class_u_r_l}{URL} record type has the following API\+:
...
These properties should be treated with care, as in general changing them will cause the \doxylink{class_u_r_l}{URL} record to be in an inconsistent state until the appropriate invocation of {\ttfamily basic\+URLParse} is used to fix it up. You can see examples of this in the \doxylink{class_u_r_l}{URL} Standard, where there are many step sequences like "{}4. Set context object’s url’s fragment to the empty string. 5. Basic URL parse \+\_\+input\+\_\+ with context object’s url as \+\_\+url\+\_\+ and fragment state as \+\_\+state override\+\_\+."{} In between those two steps, a \doxylink{class_u_r_l}{URL} record is in an unusable state.

The return value of "{}failure"{} in the spec is represented by {\ttfamily null}. That is, functions like {\ttfamily parse\+URL} and {\ttfamily basic\+URLParse} can return {\itshape either} a \doxylink{class_u_r_l}{URL} record {\itshape or} {\ttfamily null}.\hypertarget{README.md_autotoc_md8200}{}\doxysubsubsection{\texorpdfstring{{\ttfamily whatwg-\/url/webidl2js-\/wrapper} module}{{\ttfamily whatwg-\/url/webidl2js-\/wrapper} module}}\label{README.md_autotoc_md8200}
This module exports the {\ttfamily \doxylink{class_u_r_l}{URL}} and {\ttfamily URLSearch\+Params} \href{https://github.com/jsdom/webidl2js\#for-interfaces}{\texttt{interface wrappers API}} generated by \href{https://github.com/jsdom/webidl2js}{\texttt{webidl2js}}.\hypertarget{README.md_autotoc_md8201}{}\doxysubsection{\texorpdfstring{Development instructions}{Development instructions}}\label{README.md_autotoc_md8201}
...
Serve the contents of the {\ttfamily live-\/viewer} directory using any web server.\hypertarget{README.md_autotoc_md8202}{}\doxysubsection{\texorpdfstring{Supporting whatwg-\/url}{Supporting whatwg-\/url}}\label{README.md_autotoc_md8202}
