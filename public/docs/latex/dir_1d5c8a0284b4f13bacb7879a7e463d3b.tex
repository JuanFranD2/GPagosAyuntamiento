\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/chokidar Directory Reference}
\hypertarget{dir_1d5c8a0284b4f13bacb7879a7e463d3b}{}\label{dir_1d5c8a0284b4f13bacb7879a7e463d3b}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/chokidar Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/chokidar Directory Reference}}
...
\hypertarget{README.md_autotoc_md1948}{}\doxysubsection{\texorpdfstring{Chokidar \mbox{[}!\mbox{[}Weekly downloads\mbox{]}(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https\+://img.\+shields.\+io/npm/dw/chokidar.\+svg}})\mbox{]}(\href{https://github.com/paulmillr/chokidar}{\texttt{https\+://github.\+com/paulmillr/chokidar}}) \mbox{[}!\mbox{[}Yearly downloads\mbox{]}(\href{https://img.shields.io/npm/dy/chokidar.svg}{\texttt{https\+://img.\+shields.\+io/npm/dy/chokidar.\+svg}})\mbox{]}(\href{https://github.com/paulmillr/chokidar}{\texttt{https\+://github.\+com/paulmillr/chokidar}})}{Chokidar \mbox{[}!\mbox{[}Weekly downloads\mbox{]}(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https\+://img.\+shields.\+io/npm/dw/chokidar.\+svg}})\mbox{]}(\href{https://github.com/paulmillr/chokidar}{\texttt{https\+://github.\+com/paulmillr/chokidar}}) \mbox{[}!\mbox{[}Yearly downloads\mbox{]}(\href{https://img.shields.io/npm/dy/chokidar.svg}{\texttt{https\+://img.\+shields.\+io/npm/dy/chokidar.\+svg}})\mbox{]}(\href{https://github.com/paulmillr/chokidar}{\texttt{https\+://github.\+com/paulmillr/chokidar}})}}\label{README.md_autotoc_md1948}
\begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}


\href{https://www.npmjs.com/package/chokidar}{\texttt{}}\hypertarget{README.md_autotoc_md1949}{}\doxysubsection{\texorpdfstring{Why?}{Why?}}\label{README.md_autotoc_md1949}
...
Version 3 is out! Check out our blog post about it\+: \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{Chokidar 3\+: How to save 32TB of traffic every week}}\hypertarget{README.md_autotoc_md1950}{}\doxysubsection{\texorpdfstring{How?}{How?}}\label{README.md_autotoc_md1950}
...
\begin{DoxyCode}{0}
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1952}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md1952}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1953}{}\doxysubsubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{README.md_autotoc_md1953}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1954}{}\doxysubsubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{README.md_autotoc_md1954}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1955}{}\doxysubsubsubsection{\texorpdfstring{Performance}{Performance}}\label{README.md_autotoc_md1955}
...
\item {\ttfamily await\+Write\+Finish.\+poll\+Interval} (default\+: 100). \doxylink{class_file}{File} size polling interval, in milliseconds.
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1956}{}\doxysubsubsubsection{\texorpdfstring{Errors}{Errors}}\label{README.md_autotoc_md1956}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1957}{}\doxysubsubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{README.md_autotoc_md1957}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1958}{}\doxysubsection{\texorpdfstring{CLI}{CLI}}\label{README.md_autotoc_md1958}
If you need a CLI interface for your file watching, check out \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{README.md_autotoc_md1959}{}\doxysubsection{\texorpdfstring{Install Troubleshooting}{Install Troubleshooting}}\label{README.md_autotoc_md1959}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1960}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{README.md_autotoc_md1960}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1961}{}\doxysubsection{\texorpdfstring{Also}{Also}}\label{README.md_autotoc_md1961}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four). This word is also used in other languages like Urdu as (چوکیدار) which is widely used in Pakistan and India.\hypertarget{README.md_autotoc_md1962}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md1962}
