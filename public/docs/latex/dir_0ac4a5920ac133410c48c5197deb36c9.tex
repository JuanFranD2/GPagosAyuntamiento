\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/enhanced-\/resolve Directory Reference}
\hypertarget{dir_0ac4a5920ac133410c48c5197deb36c9}{}\label{dir_0ac4a5920ac133410c48c5197deb36c9}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/enhanced-\/resolve Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/enhanced-\/resolve Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md2563}{}\doxysubsection{\texorpdfstring{enhanced-\/resolve}{enhanced-\/resolve}}\label{README.md_autotoc_md2563}
...
Offers an async require.\+resolve function. It\textquotesingle{}s highly configurable.\hypertarget{README.md_autotoc_md2564}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md2564}

\begin{DoxyItemize}
\item plugin system
\item provide a custom filesystem
\item sync and async node.\+js filesystems included
\end{DoxyItemize}\hypertarget{README.md_autotoc_md2565}{}\doxysubsection{\texorpdfstring{Getting Started}{Getting Started}}\label{README.md_autotoc_md2565}
\hypertarget{README.md_autotoc_md2566}{}\doxysubsubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md2566}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2567}{}\doxysubsubsection{\texorpdfstring{Resolve}{Resolve}}\label{README.md_autotoc_md2567}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2568}{}\doxysubsubsection{\texorpdfstring{Creating a Resolver}{Creating a Resolver}}\label{README.md_autotoc_md2568}
The easiest way to create a resolver is to use the {\ttfamily create\+Resolver} function on {\ttfamily Resolve\+Factory}, along with one of the supplied \doxylink{class_file}{File} System implementations.
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2569}{}\doxysubsubsubsection{\texorpdfstring{Resolver Options}{Resolver Options}}\label{README.md_autotoc_md2569}
\tabulinesep=1mm
...
cache\+Predicate  &\doxylink{rector-migrate_8php_affc7ca71e2c30ccc9604c2697809c870}{function()} \{ return true \};  &A function which decides whether a request should be cached or not. An object is passed to the function with {\ttfamily path} and {\ttfamily request} properties.  \\\cline{1-3}
...
fully\+Specified  &false  &\doxylink{class_request}{Request} passed to resolve is already fully specified and extensions or main files are not resolved for it (they are still resolved for internal requests)  \\\cline{1-3}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md2570}{}\doxysubsection{\texorpdfstring{Plugins}{Plugins}}\label{README.md_autotoc_md2570}
...
A plugin should be a {\ttfamily class} (or its ES5 equivalent) with an {\ttfamily apply} method. The {\ttfamily apply} method will receive a {\ttfamily resolver} instance, that can be used to hook in to the event system.\hypertarget{README.md_autotoc_md2571}{}\doxysubsubsection{\texorpdfstring{Plugin Boilerplate}{Plugin Boilerplate}}\label{README.md_autotoc_md2571}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2575}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md2575}
