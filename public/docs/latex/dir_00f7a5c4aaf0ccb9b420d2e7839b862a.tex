\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/vendor/sebastian/diff Directory Reference}
\hypertarget{dir_00f7a5c4aaf0ccb9b420d2e7839b862a}{}\label{dir_00f7a5c4aaf0ccb9b420d2e7839b862a}\index{C:/xampp/htdocs/GPagosAyuntamiento/vendor/sebastian/diff Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/vendor/sebastian/diff Directory Reference}}
...
\mbox{[}!\mbox{[}Latest Stable Version\mbox{]}(\href{https://poser.pugx.org/sebastian/diff/v/stable.png}{\texttt{https\+://poser.\+pugx.\+org/sebastian/diff/v/stable.\+png}})\mbox{]}(\href{https://packagist.org/packages/sebastian/diff}{\texttt{https\+://packagist.\+org/packages/sebastian/diff}}) \href{https://github.com/sebastianbergmann/diff/actions}{\texttt{}} \href{https://codecov.io/gh/sebastianbergmann/diff}{\texttt{}}\hypertarget{README.md_autotoc_md10769}{}\doxysubsection{\texorpdfstring{sebastian/diff}{sebastian/diff}}\label{README.md_autotoc_md10769}
Diff implementation for PHP, factored out of \doxylink{namespace_p_h_p_unit}{PHPUnit} into a stand-\/alone component.\hypertarget{README.md_autotoc_md10770}{}\doxysubsubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md10770}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10771}{}\doxysubsubsubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md10771}
\hypertarget{README.md_autotoc_md10772}{}\doxysubsubsubsubsection{\texorpdfstring{Generating diff}{Generating diff}}\label{README.md_autotoc_md10772}
...
\DoxyCodeLine{print\ \$differ-\/>\mbox{\hyperlink{class_sebastian_bergmann_1_1_diff_1_1_differ_a54bf9d51cdf54e0a177c2af13860902b}{diff}}(\textcolor{stringliteral}{'foo'},\ \textcolor{stringliteral}{'bar'});}
...
There are three output builders available in this package\+:\hypertarget{README.md_autotoc_md10773}{}\doxysubsubsubsubsection{\texorpdfstring{Unified\+Diff\+Output\+Builder}{Unified\+Diff\+Output\+Builder}}\label{README.md_autotoc_md10773}
This is default builder, which generates the output close to udiff and is used by \doxylink{namespace_p_h_p_unit}{PHPUnit}.
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10774}{}\doxysubsubsubsubsection{\texorpdfstring{Strict\+Unified\+Diff\+Output\+Builder}{Strict\+Unified\+Diff\+Output\+Builder}}\label{README.md_autotoc_md10774}
...
\DoxyCodeLine{\ \ \ \ \textcolor{stringliteral}{'fromFile'}\ \ \ \ \ \ \ \ \ \ \ \ =>\ \textcolor{stringliteral}{''},}
\DoxyCodeLine{\ \ \ \ \textcolor{stringliteral}{'fromFileDate'}\ \ \ \ \ \ \ \ =>\ \textcolor{keyword}{null},}
\DoxyCodeLine{\ \ \ \ \textcolor{stringliteral}{'toFile'}\ \ \ \ \ \ \ \ \ \ \ \ \ \ =>\ \textcolor{stringliteral}{''},}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10775}{}\doxysubsubsubsubsection{\texorpdfstring{Diff\+Only\+Output\+Builder}{Diff\+Only\+Output\+Builder}}\label{README.md_autotoc_md10775}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10776}{}\doxysubsubsubsubsection{\texorpdfstring{Diff\+Output\+Builder\+Interface}{Diff\+Output\+Builder\+Interface}}\label{README.md_autotoc_md10776}
You can pass any output builder to the {\ttfamily Differ} class as longs as it implements the {\ttfamily Diff\+Output\+Builder\+Interface}.\hypertarget{README.md_autotoc_md10777}{}\doxysubsubsubsubsection{\texorpdfstring{Parsing diff}{Parsing diff}}\label{README.md_autotoc_md10777}
...
Note\+: If the chunk size is 0 lines, i.\+e., {\ttfamily get\+Start\+Range()} or {\ttfamily get\+End\+Range()} return 0, the number of line returned by {\ttfamily get\+Start()} or {\ttfamily get\+End()} is one lower than one would expect. It is the line number after which the chunk should be inserted or deleted; in all other cases, it gives the first line number of the replaced range of lines. 