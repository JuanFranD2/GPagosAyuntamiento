\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/@jest/environment-\/jsdom-\/abstract/node\+\_\+modules/pretty-\/format Directory Reference}
\hypertarget{dir_776569205ef62f8b35ed41fb1b4a9085}{}\label{dir_776569205ef62f8b35ed41fb1b4a9085}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/"@jest/environment-\/jsdom-\/abstract/node\_modules/pretty-\/format Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/"@jest/environment-\/jsdom-\/abstract/node\_modules/pretty-\/format Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md713}{}\doxysubsection{\texorpdfstring{pretty-\/format}{pretty-\/format}}\label{README.md_autotoc_md713}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md714}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md714}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ yarn\ add\ pretty-\/format}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md715}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md715}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md716}{}\doxysubsection{\texorpdfstring{Usage with options}{Usage with options}}\label{README.md_autotoc_md716}
...
{\ttfamily compare\+Keys}  &{\ttfamily function\textbackslash{}\texorpdfstring{$\vert$}{|}null}  &{\ttfamily undefined}  &compare function used when sorting object keys, {\ttfamily null} can be used to skip over sorting  \\\cline{1-4}
...
{\ttfamily max\+Width}  &{\ttfamily number}  &{\ttfamily Infinity}  &number of elements to print in arrays, sets, and so on  \\\cline{1-4}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md717}{}\doxysubsection{\texorpdfstring{Usage with plugins}{Usage with plugins}}\label{README.md_autotoc_md717}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md718}{}\doxysubsection{\texorpdfstring{Usage in Jest}{Usage in Jest}}\label{README.md_autotoc_md718}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md719}{}\doxysubsection{\texorpdfstring{Writing plugins}{Writing plugins}}\label{README.md_autotoc_md719}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md720}{}\doxysubsubsection{\texorpdfstring{test}{test}}\label{README.md_autotoc_md720}
...
\begin{DoxyItemize}
\item `Type\+Error\+: Cannot read property \textquotesingle{}whatever' of null{\ttfamily }
\item {\ttfamily }Type\+Error\+: Cannot read property \textquotesingle{}whatever\textquotesingle{} of undefined\`{}
\end{DoxyItemize}
...
Pay attention to efficiency in {\ttfamily test} because {\ttfamily pretty-\/format} calls it often.\hypertarget{README.md_autotoc_md721}{}\doxysubsubsection{\texorpdfstring{serialize}{serialize}}\label{README.md_autotoc_md721}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md722}{}\doxysubsubsection{\texorpdfstring{config}{config}}\label{README.md_autotoc_md722}
\tabulinesep=1mm
...
{\ttfamily compare\+Keys}  &{\ttfamily function\textbackslash{}\texorpdfstring{$\vert$}{|}null}  &compare function used when sorting object keys, {\ttfamily null} can be used to skip over sorting  \\\cline{1-3}
...
{\ttfamily spacing\+Inner}  &{\ttfamily string}  &spacing to separate items in a list  \\\cline{1-3}
{\ttfamily spacing\+Outer}  &{\ttfamily string}  &spacing to enclose a list of items  \\\cline{1-3}
\end{longtabu}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md723}{}\doxysubsubsection{\texorpdfstring{Example of serialize and test}{Example of serialize and test}}\label{README.md_autotoc_md723}
...
\DoxyCodeLine{\ \ \ \ \ \ ?\ \`{}[\$\{name\}]`}
\DoxyCodeLine{\ \ \ \ \ \ :\ \`{}\$\{config.min\ ?\ ''\ :\ \`{}\$\{name\}\ \`{}\}[\$\{serializeItems(}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ array,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ config,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ indentation,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ depth,}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md724}{}\doxysubsubsection{\texorpdfstring{print}{print}}\label{README.md_autotoc_md724}
...
\item the key is the same (for example, {\ttfamily tag})
\item the value in {\ttfamily colors} is a object with {\ttfamily open} and {\ttfamily close} properties whose values are escape codes from \href{https://github.com/chalk/ansi-styles}{\texttt{ansi-\/styles}} for the color value in {\ttfamily theme} (for example, `\textquotesingle{}cyan'\`{})
\end{DoxyItemize}\hypertarget{README.md_autotoc_md725}{}\doxysubsubsection{\texorpdfstring{Example of print and test}{Example of print and test}}\label{README.md_autotoc_md725}
