\chapter{object-\/hash }
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme}{}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme}\index{object-\/hash@{object-\/hash}}
\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5321}%
\Hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5321}%
...
\begin{DoxyItemize}
\item \doxylink{class_hash}{Hash} values of any type.
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5322}{}\doxysection{\texorpdfstring{Versioning Disclaimer}{Versioning Disclaimer}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5322}
...
For more information, see \href{https://github.com/puleos/object-hash/issues/30}{\texttt{this discussion}}.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5323}{}\doxysection{\texorpdfstring{hash(value, options)}{hash(value, options)}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5323}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5324}{}\doxysection{\texorpdfstring{hash.\+sha1(value)}{hash.\+sha1(value)}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5324}
\doxylink{class_hash}{Hash} using the sha1 algorithm.

Note that SHA-\/1 is not considered secure, and a stronger algorithm should be used if a cryptographical hash is desired.

{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}sha1'\})\`{}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5325}{}\doxysection{\texorpdfstring{hash.\+keys(value)}{hash.\+keys(value)}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5325}
\doxylink{class_hash}{Hash} object keys using the sha1 algorithm, values ignored.

{\itshape Sugar method, equivalent to} {\ttfamily hash(value, \{exclude\+Values\+: true\})}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5326}{}\doxysection{\texorpdfstring{hash.\+MD5(value)}{hash.\+MD5(value)}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5326}
\doxylink{class_hash}{Hash} using the md5 algorithm.
...
{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}md5'\})\`{}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5327}{}\doxysection{\texorpdfstring{hash.\+keys\+MD5(value)}{hash.\+keys\+MD5(value)}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5327}
\doxylink{class_hash}{Hash} object keys using the md5 algorithm, values ignored.

Note that the MD5 algorithm is not considered secure, and a stronger algorithm should be used if a cryptographical hash is desired.

{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}md5', exclude\+Values\+: true\})\`{}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5328}{}\doxysection{\texorpdfstring{hash.\+write\+To\+Stream(value, \mbox{[}options,\mbox{]} stream)}{hash.\+write\+To\+Stream(value, \mbox{[}options,\mbox{]} stream)}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5328}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5329}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5329}
node\+:
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5330}{}\doxysection{\texorpdfstring{Example usage}{Example usage}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5330}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5331}{}\doxysection{\texorpdfstring{Legacy Browser Support}{Legacy Browser Support}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5331}
IE \texorpdfstring{$<$}{<}= 8 and Opera \texorpdfstring{$<$}{<}= 11 support dropped in version 0.\+3.\+0. If you require legacy browser support you must either use an ES5 shim or use version 0.\+2.\+5 of this module.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5332}{}\doxysection{\texorpdfstring{Development}{Development}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5332}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5333}{}\doxysection{\texorpdfstring{Node Docker Wrapper}{Node Docker Wrapper}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5333}
If you want to stand this up in a docker container, you should take at look at the \href{https://github.com/bean5/node-object-hash}{\texttt{}} project.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5334}{}\doxysubsection{\texorpdfstring{gulp tasks}{gulp tasks}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5334}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5335}{}\doxysection{\texorpdfstring{License}{License}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5335}
MIT\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5336}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5336}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5337}{}\doxysubsection{\texorpdfstring{v2.\+0.\+0}{v2.\+0.\+0}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2node__modules_2object-hash_2readme_autotoc_md5337}
