\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/vendor/nesbot/carbon/src/\+Carbon/\+Traits/\+Mixin.\+php}
\hypertarget{_c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2nesbot_2carbon_2src_2_carbon_2_traits_2_mixin_8php-example}{}\label{_c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2nesbot_2carbon_2src_2_carbon_2_traits_2_mixin_8php-example}Mix another object into the class.
...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{protected}\ \textcolor{keyword}{static}\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}\ \$macroContextStack\ =\ [];}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{static}\ \textcolor{keyword}{function}\ \mbox{\hyperlink{interface_carbon_1_1_carbon_interface_af5f3516ed4cf869b9b2b4b83d1490361}{mixin}}(\textcolor{keywordtype}{object}|\textcolor{keywordtype}{string}\ \$mixin):\ void}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ );}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{foreach}\ (\$methods\ as\ \mbox{\hyperlink{class_carbon_1_1_exceptions_1_1_unknown_method_exception_a12661b2fc0f57f97e30a1620889ce9c6}{\$method}})\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{class_carbon_1_1_exceptions_1_1_unknown_method_exception_a12661b2fc0f57f97e30a1620889ce9c6}{\$method}}-\/>isConstructor()\ ||\ \mbox{\hyperlink{class_carbon_1_1_exceptions_1_1_unknown_method_exception_a12661b2fc0f57f97e30a1620889ce9c6}{\$method}}-\/>isDestructor())\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$macro\ =\ \mbox{\hyperlink{class_carbon_1_1_exceptions_1_1_unknown_method_exception_a12661b2fc0f57f97e30a1620889ce9c6}{\$method}}-\/>invoke(\$mixin);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\(\backslash\)is\_callable(\$macro))\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ static::macro(\mbox{\hyperlink{class_carbon_1_1_exceptions_1_1_unknown_method_exception_a12661b2fc0f57f97e30a1620889ce9c6}{\$method}}-\/>name,\ \$macro);}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{class_carbon_1_1_factory_a0a45c6f51b410319c7dea0c902ea608d}{\$className}}\ =\ \(\backslash\)get\_class(\$context);}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ static::macro(\$name,\ \textcolor{keyword}{function}\ (...\$parameters)\ use\ (\$closureBase,\ \mbox{\hyperlink{class_carbon_1_1_factory_a0a45c6f51b410319c7dea0c902ea608d}{\$className}},\ \$baseClass)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \$downContext\ =\ isset(\$this)\ ?\ (\$this)\ :\ \mbox{\hyperlink{resources_2views_2livewire_2pages_2auth_2confirm-password_8blade_8php_ae3b81d385ca4c26109dfbda28c563e2b}{new}}\ \$baseClass();}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \$context\ =\ isset(\$this)\ ?\ \$this-\/>\mbox{\hyperlink{interface_carbon_1_1_carbon_interface_a5a235c9fff6136ca2f534dd36ed4fb13}{cast}}(\mbox{\hyperlink{class_carbon_1_1_factory_a0a45c6f51b410319c7dea0c902ea608d}{\$className}})\ :\ \mbox{\hyperlink{resources_2views_2livewire_2pages_2auth_2confirm-password_8blade_8php_ae3b81d385ca4c26109dfbda28c563e2b}{new}}\ \mbox{\hyperlink{class_carbon_1_1_factory_a0a45c6f51b410319c7dea0c902ea608d}{\$className}}();}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!(\$result\ instanceof\ \mbox{\hyperlink{class_carbon_1_1_factory_a0a45c6f51b410319c7dea0c902ea608d}{\$className}}))\ \{}
...
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{private}\ \textcolor{keyword}{static}\ \textcolor{keyword}{function}\ getAnonymousClassCodeForTrait(\textcolor{keywordtype}{string}\ \$trait):\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a0fddcd2deb3b8c8c7745c9763d3704b7}{string}}}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ yield\ \mbox{\hyperlink{namespace_symfony_1_1_component_1_1_routing_1_1_loader_1_1_configurator_1_1_traits_a58551b63ba97fb35b928f11f36b1fac6}{\$name}};}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_carbon_1_1_carbon_interval_a817082ace0e2589d27b22890290aa4a9}{end}}(static::\$macroContextStack)\ ?:\ \textcolor{keyword}{null};}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{protected}\ \textcolor{keyword}{static}\ \textcolor{keyword}{function}\ \textcolor{keyword}{this}():\ static}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_carbon_1_1_carbon_interval_a817082ace0e2589d27b22890290aa4a9}{end}}(static::\$macroContextStack)\ ?:\ \textcolor{keyword}{new}\ \textcolor{keyword}{static}();}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\}}
