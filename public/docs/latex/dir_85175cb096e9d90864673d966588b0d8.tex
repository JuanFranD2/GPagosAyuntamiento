\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/jest-\/validate Directory Reference}
\hypertarget{dir_85175cb096e9d90864673d966588b0d8}{}\label{dir_85175cb096e9d90864673d966588b0d8}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/jest-\/validate Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/jest-\/validate Directory Reference}}
...
\hypertarget{README.md_autotoc_md4424}{}\doxysubsection{\texorpdfstring{jest-\/validate}{jest-\/validate}}\label{README.md_autotoc_md4424}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md4425}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md4425}
...
{\ttfamily example\+Config} is the only option required.\hypertarget{README.md_autotoc_md4426}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md4426}
...
Almost anything can be overwritten to suite your needs.\hypertarget{README.md_autotoc_md4427}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md4427}
...
The last condition is a special syntax that allows validating where more than one type is permissible; see example below. It\textquotesingle{}s acceptable to have multiple values of the same type in the example, so you can also use this syntax to provide more than one example. When a validation failure occurs, the error message will show all other values in the array as examples.\hypertarget{README.md_autotoc_md4429}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{README.md_autotoc_md4429}
Minimal example\+:
...
This will output\+:\hypertarget{README.md_autotoc_md4430}{}\doxysubsubsubsection{\texorpdfstring{Warning\+:}{Warning\+:}}\label{README.md_autotoc_md4430}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md4431}{}\doxysubsubsubsection{\texorpdfstring{Error\+:}{Error\+:}}\label{README.md_autotoc_md4431}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md4432}{}\doxysubsection{\texorpdfstring{Example validating multiple types}{Example validating multiple types}}\label{README.md_autotoc_md4432}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md4433}{}\doxysubsubsubsection{\texorpdfstring{Error\+:}{Error\+:}}\label{README.md_autotoc_md4433}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md4434}{}\doxysubsubsubsection{\texorpdfstring{Deprecation}{Deprecation}}\label{README.md_autotoc_md4434}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md4435}{}\doxysubsection{\texorpdfstring{Example validating CLI arguments}{Example validating CLI arguments}}\label{README.md_autotoc_md4435}
