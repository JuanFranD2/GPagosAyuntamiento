\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/json-\/parse-\/even-\/better-\/errors Directory Reference}
\hypertarget{dir_c7a48ecdba1f4f896a3e87b961710d67}{}\label{dir_c7a48ecdba1f4f896a3e87b961710d67}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/json-\/parse-\/even-\/better-\/errors Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/json-\/parse-\/even-\/better-\/errors Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md4767}{}\doxysubsection{\texorpdfstring{json-\/parse-\/even-\/better-\/errors}{json-\/parse-\/even-\/better-\/errors}}\label{README.md_autotoc_md4767}
...
It also preserves the newline and indentation styles of the JSON data, by putting them in the object or array in the `Symbol.\+for(\textquotesingle{}indent'){\ttfamily  and }Symbol.\+for(\textquotesingle{}newline\textquotesingle{})\`{} properties.\hypertarget{README.md_autotoc_md4768}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md4768}
{\ttfamily \$ npm install -\/-\/save json-\/parse-\/even-\/better-\/errors}\hypertarget{README.md_autotoc_md4769}{}\doxysubsection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{README.md_autotoc_md4769}
...
\item \`{}parse\`{}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md4770}{}\doxysubsubsection{\texorpdfstring{Example}{Example}}\label{README.md_autotoc_md4770}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md4771}{}\doxysubsubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md4771}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md4772}{}\doxysubsection{\texorpdfstring{Indentation}{Indentation}}\label{README.md_autotoc_md4772}
...
Indentation is determined by looking at the whitespace between the initial {\ttfamily \{} and {\ttfamily \mbox{[}} and the character that follows it. If you have lots of weird inconsistent indentation, then it won\textquotesingle{}t track that or give you any way to preserve it. Whether this is a bug or a feature is debatable ;)\hypertarget{README.md_autotoc_md4773}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md4773}
\hypertarget{README.md_autotoc_md4774}{}\doxysubsubsubsection{\texorpdfstring{\label{_parse}%
 {\ttfamily parse(txt, reviver = null, context = 20)}}{\label{_parse}%
 {\ttfamily parse(txt, reviver = null, context = 20)}}}\label{README.md_autotoc_md4774}
Works just like {\ttfamily JSON.\+parse}, but will include a bit more information when an error happens, and attaches a `Symbol.\+for(\textquotesingle{}indent'){\ttfamily  and }Symbol.\+for(\textquotesingle{}newline\textquotesingle{}){\ttfamily  on objects and arrays. This throws a }JSONParse\+Error\`{}.\hypertarget{README.md_autotoc_md4775}{}\doxysubsubsubsection{\texorpdfstring{\label{_parse}%
 {\ttfamily parse.\+no\+Exceptions(txt, reviver = null)}}{\label{_parse}%
 {\ttfamily parse.\+no\+Exceptions(txt, reviver = null)}}}\label{README.md_autotoc_md4775}
Works just like {\ttfamily JSON.\+parse}, but will return {\ttfamily undefined} rather than throwing an error.\hypertarget{README.md_autotoc_md4776}{}\doxysubsubsubsection{\texorpdfstring{\label{_jsonparseerror}%
 {\ttfamily class JSONParse\+Error(er, text, context = 20, caller = null)}}{\label{_jsonparseerror}%
 {\ttfamily class JSONParse\+Error(er, text, context = 20, caller = null)}}}\label{README.md_autotoc_md4776}
