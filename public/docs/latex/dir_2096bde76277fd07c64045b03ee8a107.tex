\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/vendor/guzzlehttp/psr7 Directory Reference}
\hypertarget{dir_2096bde76277fd07c64045b03ee8a107}{}\label{dir_2096bde76277fd07c64045b03ee8a107}\index{C:/xampp/htdocs/GPagosAyuntamiento/vendor/guzzlehttp/psr7 Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/vendor/guzzlehttp/psr7 Directory Reference}}
...
\hypertarget{README.md_autotoc_md9457}{}\doxysubsection{\texorpdfstring{PSR-\/7 Message Implementation}{PSR-\/7 Message Implementation}}\label{README.md_autotoc_md9457}
This repository contains a full \href{https://www.php-fig.org/psr/psr-7/}{\texttt{PSR-\/7}} message implementation, several stream decorators, and some helpful functionality like query string parsing.
 ...
 \hypertarget{README.md_autotoc_md9458}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md9458}
This package comes with a number of stream implementations and stream decorators.\hypertarget{README.md_autotoc_md9459}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md9459}

\begin{DoxyCode}{0}
\DoxyCodeLine{composer\ require\ guzzlehttp/psr7}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md9460}{}\doxysubsection{\texorpdfstring{Version Guidance}{Version Guidance}}\label{README.md_autotoc_md9460}
\tabulinesep=1mm
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Version  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Status  }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ PHP Version  }\\\cline{1-3}
\endhead
1.\+x  &EOL (2024-\/06-\/30)  &\texorpdfstring{$>$}{>}=5.\+4,\texorpdfstring{$<$}{<}8.\+2  \\\cline{1-3}
2.\+x  &Latest  &\texorpdfstring{$>$}{>}=7.\+2.\+5,\texorpdfstring{$<$}{<}8.\+5  \\\cline{1-3}
\end{longtabu}
\hypertarget{README.md_autotoc_md9461}{}\doxysubsection{\texorpdfstring{Append\+Stream}{Append\+Stream}}\label{README.md_autotoc_md9461}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9462}{}\doxysubsection{\texorpdfstring{Buffer\+Stream}{Buffer\+Stream}}\label{README.md_autotoc_md9462}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9463}{}\doxysubsection{\texorpdfstring{Caching\+Stream}{Caching\+Stream}}\label{README.md_autotoc_md9463}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9464}{}\doxysubsection{\texorpdfstring{Dropping\+Stream}{Dropping\+Stream}}\label{README.md_autotoc_md9464}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9465}{}\doxysubsection{\texorpdfstring{Fn\+Stream}{Fn\+Stream}}\label{README.md_autotoc_md9465}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9466}{}\doxysubsection{\texorpdfstring{Inflate\+Stream}{Inflate\+Stream}}\label{README.md_autotoc_md9466}
...
This stream decorator converts the provided stream to a PHP stream resource, then appends the zlib.\+inflate filter. The stream is then converted back to a Guzzle stream resource to be used as a Guzzle stream.\hypertarget{README.md_autotoc_md9467}{}\doxysubsection{\texorpdfstring{Lazy\+Open\+Stream}{Lazy\+Open\+Stream}}\label{README.md_autotoc_md9467}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9468}{}\doxysubsection{\texorpdfstring{Limit\+Stream}{Limit\+Stream}}\label{README.md_autotoc_md9468}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9469}{}\doxysubsection{\texorpdfstring{Multipart\+Stream}{Multipart\+Stream}}\label{README.md_autotoc_md9469}
{\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}Multipart\+Stream}

Stream that when read returns bytes for a streaming multipart or multipart/form-\/data stream.\hypertarget{README.md_autotoc_md9470}{}\doxysubsection{\texorpdfstring{No\+Seek\+Stream}{No\+Seek\+Stream}}\label{README.md_autotoc_md9470}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9471}{}\doxysubsection{\texorpdfstring{Pump\+Stream}{Pump\+Stream}}\label{README.md_autotoc_md9471}
{\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}Pump\+Stream}

Provides a read only stream that pumps data from a PHP callable.

When invoking the provided callable, the Pump\+Stream will pass the amount of data requested to read to the callable. The callable can choose to ignore this value and return fewer or more bytes than requested. Any extra data returned by the provided callable is buffered internally until drained using the read() function of the Pump\+Stream. The provided callable MUST return false when there is no more data to read.\hypertarget{README.md_autotoc_md9472}{}\doxysubsection{\texorpdfstring{Implementing stream decorators}{Implementing stream decorators}}\label{README.md_autotoc_md9472}
Creating a stream decorator is very easy thanks to the {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}Stream\+Decorator\+Trait}. This trait provides methods that implement {\ttfamily Psr\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Stream\+Interface} by proxying to an underlying stream. Just {\ttfamily use} the {\ttfamily Stream\+Decorator\+Trait} and implement your custom methods.
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9473}{}\doxysubsection{\texorpdfstring{PHP Stream\+Wrapper}{PHP Stream\+Wrapper}}\label{README.md_autotoc_md9473}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9474}{}\doxysubsection{\texorpdfstring{Static API}{Static API}}\label{README.md_autotoc_md9474}
There are various static methods available under the {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7} namespace.\hypertarget{README.md_autotoc_md9475}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::to\+String}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::to\+String}}}\label{README.md_autotoc_md9475}
...
\DoxyCodeLine{echo\ \mbox{\hyperlink{class_guzzle_http_1_1_psr7_1_1_message_a61fed09ecd12f06595bb87c49380aaa3}{GuzzleHttp\(\backslash\)Psr7\(\backslash\)Message::toString}}(\$request);}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md9476}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::body\+Summary}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::body\+Summary}}}\label{README.md_autotoc_md9476}
...
Will return {\ttfamily null} if the response is not printable.\hypertarget{README.md_autotoc_md9477}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::rewind\+Body}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::rewind\+Body}}}\label{README.md_autotoc_md9477}
{\ttfamily public static function rewind\+Body(Message\+Interface \$message)\+: void}

Attempts to rewind a message body and throws an exception on failure.

The body of the message will only be rewound if a call to {\ttfamily tell()} returns a value other than {\ttfamily 0}.\hypertarget{README.md_autotoc_md9478}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Message}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Message}}}\label{README.md_autotoc_md9478}
{\ttfamily public static function parse\+Message(string \$message)\+: array}

Parses an HTTP message into an associative array.

The array contains the "{}start-\/line"{} key containing the start line of the message, "{}headers"{} key containing an associative array of header array values, and a "{}body"{} key containing the body of the message.\hypertarget{README.md_autotoc_md9479}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Request\+Uri}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Request\+Uri}}}\label{README.md_autotoc_md9479}
{\ttfamily public static function parse\+Request\+Uri(string \$path, array \$headers)\+: string}

Constructs a URI for an HTTP request message.\hypertarget{README.md_autotoc_md9480}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Request}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Request}}}\label{README.md_autotoc_md9480}
{\ttfamily public static function parse\+Request(string \$message)\+: \doxylink{class_request}{Request}}

Parses a request message string into a request object.\hypertarget{README.md_autotoc_md9481}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Response}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Message\+::parse\+Response}}}\label{README.md_autotoc_md9481}
{\ttfamily public static function parse\+Response(string \$message)\+: \doxylink{class_response}{Response}}

Parses a response message string into a response object.\hypertarget{README.md_autotoc_md9482}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Header\+::parse}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Header\+::parse}}}\label{README.md_autotoc_md9482}
{\ttfamily public static function parse(string\texorpdfstring{$\vert$}{|}array \$header)\+: array}

Parse an array of header values containing "{};"{} separated data into an array of associative arrays representing the header key value pair data of the header. When a parameter does not contain a value, but just contains a key, this function will inject a key with a \textquotesingle{}\textquotesingle{} string value.\hypertarget{README.md_autotoc_md9483}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Header\+::split\+List}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Header\+::split\+List}}}\label{README.md_autotoc_md9483}
...
Example headers include {\ttfamily accept}, {\ttfamily cache-\/control} and {\ttfamily if-\/none-\/match}.\hypertarget{README.md_autotoc_md9484}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Header\+::normalize} (deprecated)}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Header\+::normalize} (deprecated)}}\label{README.md_autotoc_md9484}
...
Converts an array of header values that may contain comma separated headers into an array of headers with no comma separated values.\hypertarget{README.md_autotoc_md9485}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Query\+::parse}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Query\+::parse}}}\label{README.md_autotoc_md9485}
{\ttfamily public static function parse(string \$str, int\texorpdfstring{$\vert$}{|}bool \$url\+Encoding = true)\+: array}

Parse a query string into an associative array.

If multiple values are found for the same key, the value of that key value pair will become an array. This function does not parse nested PHP style arrays into an associative array (e.\+g., {\ttfamily foo\mbox{[}a\mbox{]}=1\&foo\mbox{[}b\mbox{]}=2} will be parsed into `\mbox{[}\textquotesingle{}foo\mbox{[}a\mbox{]}' =\texorpdfstring{$>$}{>} \textquotesingle{}1\textquotesingle{}, \textquotesingle{}foo\mbox{[}b\mbox{]}\textquotesingle{} =\texorpdfstring{$>$}{>} \textquotesingle{}2\textquotesingle{}\mbox{]})\`{}.\hypertarget{README.md_autotoc_md9486}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Query\+::build}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Query\+::build}}}\label{README.md_autotoc_md9486}
{\ttfamily public static function build(array \$params, int\texorpdfstring{$\vert$}{|}false \$encoding = PHP\+\_\+\+QUERY\+\_\+\+RFC3986, bool \$treat\+Bools\+As\+Ints = true)\+: string}

Build a query string from an array of key value pairs.

This function can use the return value of {\ttfamily parse()} to build a query string. This function does not modify the provided keys when an array is encountered (like {\ttfamily http\+\_\+build\+\_\+query()} would).\hypertarget{README.md_autotoc_md9487}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::caseless\+Remove}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::caseless\+Remove}}}\label{README.md_autotoc_md9487}
{\ttfamily public static function caseless\+Remove(iterable\texorpdfstring{$<$}{<}string\texorpdfstring{$>$}{>} \$keys, \$keys, array \$data)\+: array}

Remove the items given by the keys, case insensitively from the data.\hypertarget{README.md_autotoc_md9488}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::copy\+To\+Stream}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::copy\+To\+Stream}}}\label{README.md_autotoc_md9488}
{\ttfamily public static function copy\+To\+Stream(Stream\+Interface \$source, Stream\+Interface \$dest, int \$max\+Len = -\/1)\+: void}

Copy the contents of a stream into another stream until the given number of bytes have been read.\hypertarget{README.md_autotoc_md9489}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::copy\+To\+String}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::copy\+To\+String}}}\label{README.md_autotoc_md9489}
{\ttfamily public static function copy\+To\+String(Stream\+Interface \$stream, int \$max\+Len = -\/1)\+: string}

Copy the contents of a stream into a string until the given number of bytes have been read.\hypertarget{README.md_autotoc_md9490}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::hash}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::hash}}}\label{README.md_autotoc_md9490}
{\ttfamily public static function hash(Stream\+Interface \$stream, string \$algo, bool \$raw\+Output = false)\+: string}

Calculate a hash of a stream.

This method reads the entire stream to calculate a rolling hash, based on PHP\textquotesingle{}s {\ttfamily hash\+\_\+init} functions.\hypertarget{README.md_autotoc_md9491}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::modify\+Request}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::modify\+Request}}}\label{README.md_autotoc_md9491}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md9492}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::read\+Line}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::read\+Line}}}\label{README.md_autotoc_md9492}
{\ttfamily public static function read\+Line(Stream\+Interface \$stream, ?int \$max\+Length = null)\+: string}

Read a line from the stream up to the maximum allowed buffer length.\hypertarget{README.md_autotoc_md9493}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::redact\+User\+Info}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::redact\+User\+Info}}}\label{README.md_autotoc_md9493}
{\ttfamily public static function redact\+User\+Info(Uri\+Interface \$uri)\+: Uri\+Interface}

Redact the password in the user info part of a URI.\hypertarget{README.md_autotoc_md9494}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::stream\+For}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::stream\+For}}}\label{README.md_autotoc_md9494}
...
\begin{DoxyItemize}
\item {\ttfamily Psr\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Stream\+Interface}\+: Returns the value as-\/is.
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9495}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::try\+Fopen}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::try\+Fopen}}}\label{README.md_autotoc_md9495}
{\ttfamily public static function try\+Fopen(string \$filename, string \$mode)\+: resource}

Safely opens a PHP stream resource using a filename.

When fopen fails, PHP normally raises a warning. This function adds an error handler that checks for errors and throws an exception instead.\hypertarget{README.md_autotoc_md9496}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::try\+Get\+Contents}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::try\+Get\+Contents}}}\label{README.md_autotoc_md9496}
{\ttfamily public static function try\+Get\+Contents(resource \$stream)\+: string}

Safely gets the contents of a given stream.

When stream\+\_\+get\+\_\+contents fails, PHP normally raises a warning. This function adds an error handler that checks for errors and throws an exception instead.\hypertarget{README.md_autotoc_md9497}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::uri\+For}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Utils\+::uri\+For}}}\label{README.md_autotoc_md9497}
...
This function accepts a string or Uri\+Interface and returns a Uri\+Interface for the given value. If the value is already a Uri\+Interface, it is returned as-\/is.\hypertarget{README.md_autotoc_md9498}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Mime\+Type\+::from\+Filename}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Mime\+Type\+::from\+Filename}}}\label{README.md_autotoc_md9498}
{\ttfamily public static function from\+Filename(string \$filename)\+: string\texorpdfstring{$\vert$}{|}null}

Determines the mimetype of a file by looking at its extension.\hypertarget{README.md_autotoc_md9499}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Mime\+Type\+::from\+Extension}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Mime\+Type\+::from\+Extension}}}\label{README.md_autotoc_md9499}
{\ttfamily public static function from\+Extension(string \$extension)\+: string\texorpdfstring{$\vert$}{|}null}

Maps a file extensions to a mimetype.\hypertarget{README.md_autotoc_md9500}{}\doxysubsubsection{\texorpdfstring{Upgrading from Function API}{Upgrading from Function API}}\label{README.md_autotoc_md9500}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md9501}{}\doxysubsection{\texorpdfstring{Additional URI Methods}{Additional URI Methods}}\label{README.md_autotoc_md9501}
Aside from the standard {\ttfamily Psr\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Uri\+Interface} implementation in form of the {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}\doxylink{class_uri}{Uri}} class, this library also provides additional functionality when working with URIs as static methods.\hypertarget{README.md_autotoc_md9502}{}\doxysubsubsection{\texorpdfstring{URI Types}{URI Types}}\label{README.md_autotoc_md9502}
An instance of {\ttfamily Psr\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Uri\+Interface} can either be an absolute URI or a relative reference. An absolute URI has a scheme. A relative reference is used to express a URI relative to another URI, the base URI. Relative references can be divided into several forms according to \href{https://datatracker.ietf.org/doc/html/rfc3986\#section-4.2}{\texttt{RFC 3986 Section 4.\+2}}\+:
...
The following methods can be used to identify the type of the URI.\hypertarget{README.md_autotoc_md9503}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Absolute}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Absolute}}}\label{README.md_autotoc_md9503}
{\ttfamily public static function is\+Absolute(Uri\+Interface \$uri)\+: bool}

Whether the URI is absolute, i.\+e. it has a scheme.\hypertarget{README.md_autotoc_md9504}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Network\+Path\+Reference}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Network\+Path\+Reference}}}\label{README.md_autotoc_md9504}
{\ttfamily public static function is\+Network\+Path\+Reference(Uri\+Interface \$uri)\+: bool}

Whether the URI is a network-\/path reference. A relative reference that begins with two slash characters is termed an network-\/path reference.\hypertarget{README.md_autotoc_md9505}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Absolute\+Path\+Reference}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Absolute\+Path\+Reference}}}\label{README.md_autotoc_md9505}
{\ttfamily public static function is\+Absolute\+Path\+Reference(Uri\+Interface \$uri)\+: bool}

Whether the URI is a absolute-\/path reference. A relative reference that begins with a single slash character is termed an absolute-\/path reference.\hypertarget{README.md_autotoc_md9506}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Relative\+Path\+Reference}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Relative\+Path\+Reference}}}\label{README.md_autotoc_md9506}
{\ttfamily public static function is\+Relative\+Path\+Reference(Uri\+Interface \$uri)\+: bool}

Whether the URI is a relative-\/path reference. A relative reference that does not begin with a slash character is termed a relative-\/path reference.\hypertarget{README.md_autotoc_md9507}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Same\+Document\+Reference}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Same\+Document\+Reference}}}\label{README.md_autotoc_md9507}
{\ttfamily public static function is\+Same\+Document\+Reference(Uri\+Interface \$uri, ?Uri\+Interface \$base = null)\+: bool}

Whether the URI is a same-\/document reference. A same-\/document reference refers to a URI that is, aside from its fragment component, identical to the base URI. When no base URI is given, only an empty URI reference (apart from its fragment) is considered a same-\/document reference.\hypertarget{README.md_autotoc_md9508}{}\doxysubsubsection{\texorpdfstring{URI Components}{URI Components}}\label{README.md_autotoc_md9508}
Additional methods to work with URI components.\hypertarget{README.md_autotoc_md9509}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Default\+Port}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::is\+Default\+Port}}}\label{README.md_autotoc_md9509}
{\ttfamily public static function is\+Default\+Port(Uri\+Interface \$uri)\+: bool}

Whether the URI has the default port of the current scheme. {\ttfamily Psr\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Uri\+Interface\+::get\+Port} may return null or the standard port. This method can be used independently of the implementation.\hypertarget{README.md_autotoc_md9510}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::compose\+Components}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::compose\+Components}}}\label{README.md_autotoc_md9510}
{\ttfamily public static function compose\+Components(\$scheme, \$authority, \$path, \$query, \$fragment)\+: string}

Composes a URI reference string from its various components according to \href{https://datatracker.ietf.org/doc/html/rfc3986\#section-5.3}{\texttt{RFC 3986 Section 5.\+3}}. Usually this method does not need to be called manually but instead is used indirectly via {\ttfamily Psr\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Uri\+Interface\+::\+\_\+\+\_\+to\+String}.\hypertarget{README.md_autotoc_md9511}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::from\+Parts}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::from\+Parts}}}\label{README.md_autotoc_md9511}
{\ttfamily public static function from\+Parts(array \$parts)\+: Uri\+Interface}

Creates a URI from a hash of \href{https://www.php.net/manual/en/function.parse-url.php}{\texttt{{\ttfamily parse\+\_\+url}}} components.\hypertarget{README.md_autotoc_md9512}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::with\+Query\+Value}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::with\+Query\+Value}}}\label{README.md_autotoc_md9512}
{\ttfamily public static function with\+Query\+Value(Uri\+Interface \$uri, \$key, \$value)\+: Uri\+Interface}

Creates a new URI with a specific query string value. Any existing query string values that exactly match the provided key are removed and replaced with the given key value pair. A value of null will set the query string key without a value, e.\+g. "{}key"{} instead of "{}key=value"{}.\hypertarget{README.md_autotoc_md9513}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::with\+Query\+Values}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::with\+Query\+Values}}}\label{README.md_autotoc_md9513}
{\ttfamily public static function with\+Query\+Values(Uri\+Interface \$uri, array \$key\+Value\+Array)\+: Uri\+Interface}

Creates a new URI with multiple query string values. It has the same behavior as {\ttfamily with\+Query\+Value()} but for an associative array of key =\texorpdfstring{$>$}{>} value.\hypertarget{README.md_autotoc_md9514}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::without\+Query\+Value}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+::without\+Query\+Value}}}\label{README.md_autotoc_md9514}
{\ttfamily public static function without\+Query\+Value(Uri\+Interface \$uri, \$key)\+: Uri\+Interface}

Creates a new URI with a specific query string value removed. Any existing query string values that exactly match the provided key are removed.\hypertarget{README.md_autotoc_md9515}{}\doxysubsubsection{\texorpdfstring{Cross-\/\+Origin Detection}{Cross-\/\+Origin Detection}}\label{README.md_autotoc_md9515}
{\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}Uri\+Comparator} provides methods to determine if a modified \doxylink{class_u_r_l}{URL} should be considered cross-\/origin.\hypertarget{README.md_autotoc_md9516}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Comparator\+::is\+Cross\+Origin}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Comparator\+::is\+Cross\+Origin}}}\label{README.md_autotoc_md9516}
{\ttfamily public static function is\+Cross\+Origin(Uri\+Interface \$original, Uri\+Interface \$modified)\+: bool}

Determines if a modified \doxylink{class_u_r_l}{URL} should be considered cross-\/origin with respect to an original \doxylink{class_u_r_l}{URL}.\hypertarget{README.md_autotoc_md9517}{}\doxysubsubsection{\texorpdfstring{Reference Resolution}{Reference Resolution}}\label{README.md_autotoc_md9517}
{\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}Uri\+Resolver} provides methods to resolve a URI reference in the context of a base URI according to \href{https://datatracker.ietf.org/doc/html/rfc3986\#section-5}{\texttt{RFC 3986 Section 5}}. This is for example also what web browsers do when resolving a link in a website based on the current request URI.\hypertarget{README.md_autotoc_md9518}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Resolver\+::resolve}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Resolver\+::resolve}}}\label{README.md_autotoc_md9518}
{\ttfamily public static function resolve(Uri\+Interface \$base, Uri\+Interface \$rel)\+: Uri\+Interface}

Converts the relative URI into a new URI that is resolved against the base URI.\hypertarget{README.md_autotoc_md9519}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Resolver\+::remove\+Dot\+Segments}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Resolver\+::remove\+Dot\+Segments}}}\label{README.md_autotoc_md9519}
{\ttfamily public static function remove\+Dot\+Segments(string \$path)\+: string}

Removes dot segments from a path and returns the new path according to \href{https://datatracker.ietf.org/doc/html/rfc3986\#section-5.2.4}{\texttt{RFC 3986 Section 5.\+2.\+4}}.\hypertarget{README.md_autotoc_md9520}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Resolver\+::relativize}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Resolver\+::relativize}}}\label{README.md_autotoc_md9520}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9521}{}\doxysubsubsection{\texorpdfstring{Normalization and Comparison}{Normalization and Comparison}}\label{README.md_autotoc_md9521}
{\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}Uri\+Normalizer} provides methods to normalize and compare URIs according to \href{https://datatracker.ietf.org/doc/html/rfc3986\#section-6}{\texttt{RFC 3986 Section 6}}.\hypertarget{README.md_autotoc_md9522}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Normalizer\+::normalize}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Normalizer\+::normalize}}}\label{README.md_autotoc_md9522}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md9523}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Normalizer\+::is\+Equivalent}}{{\ttfamily Guzzle\+Http\textbackslash{}Psr7\textbackslash{}Uri\+Normalizer\+::is\+Equivalent}}}\label{README.md_autotoc_md9523}
