\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/vendor/nesbot/carbon/src/\+Carbon/\+Factory.\+php}
\hypertarget{_c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2nesbot_2carbon_2src_2_carbon_2_factory_8php-example}{}\label{_c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2nesbot_2carbon_2src_2_carbon_2_factory_8php-example}Register a custom macro.
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{protected}\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}\ \$settings\ =\ [];}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{protected}\ TranslatorInterface\ \mbox{\hyperlink{discover-d234df6a22ae2b9b097ac6e3772bd950_8php_ad1bd0a7c70da186307de0136d0f0c2e3}{\$translator}};}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{protected}\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}\ \$weekendDays\ =\ [}
\DoxyCodeLine{\ \ \ \ \ \ \ \ CarbonInterface::SATURDAY,}
\DoxyCodeLine{\ \ \ \ \ \ \ \ CarbonInterface::SUNDAY,}
\DoxyCodeLine{\ \ \ \ ];}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{protected}\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}\ \$regexFormats\ =\ [}
...
\DoxyCodeLine{\ \ \ \ ];}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{protected}\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}\ \$regexFormatModifiers\ =\ [}
...
\DoxyCodeLine{\ \ \ \ ];}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ \mbox{\hyperlink{namespace_illuminate_1_1_testing_1_1_concerns_a17ea103c75f2b56cb4ebd89dbf59d2d6}{\_\_construct}}(array\ \$settings\ =\ [],\ ?\textcolor{keywordtype}{string}\ \$className\ =\ \textcolor{keyword}{null})}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\$className)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$this-\/>className\ =\ \$className;}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_a8ef27b4be15c75b142f0a532de5bc15c}{settings}}\ =\ \$settings;}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ getClassName():\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a0fddcd2deb3b8c8c7745c9763d3704b7}{string}}}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ className(?\textcolor{keywordtype}{string}\ \$className\ =\ \textcolor{keyword}{null}):\ self|\mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a0fddcd2deb3b8c8c7745c9763d3704b7}{string}}}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ \mbox{\hyperlink{namespace_carbon_1_1_traits_a8ef27b4be15c75b142f0a532de5bc15c}{settings}}(?array\ \$settings\ =\ \textcolor{keyword}{null}):\ self|\mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \$settings\ ===\ \textcolor{keyword}{null}\ ?\ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()\ :\ \$this-\/>setSettings(\$settings);}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ mergeSettings(array\ \$settings):\ self}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_a8ef27b4be15c75b142f0a532de5bc15c}{settings}}\ =\ array\_merge(\$this-\/>settings,\ \$settings);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \$this;}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ getHumanDiffOptions():\ \mbox{\hyperlink{namespace_carbon_a3a759da26a0e7e7b22a85dddef939c05}{int}}}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ (\textcolor{keywordtype}{int})\ (\$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'humanDiffOptions'}]\ ??\ 0);}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$macros\ =\ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'macros'}]\ ??\ [];}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$macros[\mbox{\hyperlink{namespace_symfony_1_1_component_1_1_routing_1_1_loader_1_1_configurator_1_1_traits_a58551b63ba97fb35b928f11f36b1fac6}{\$name}}]\ =\ \$macro;}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$this-\/>mergeSettings([}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$genericMacros\ =\ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'genericMacros'}]\ ??\ [];}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ isset(\$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'macros'}][\$name]);}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ getMacro(\textcolor{keywordtype}{string}\ \$name):\ ?callable}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'macros'}][\mbox{\hyperlink{namespace_symfony_1_1_component_1_1_routing_1_1_loader_1_1_configurator_1_1_traits_a58551b63ba97fb35b928f11f36b1fac6}{\$name}}]\ ??\ \textcolor{keyword}{null};}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ setTranslator(TranslatorInterface\ \mbox{\hyperlink{discover-d234df6a22ae2b9b097ac6e3772bd950_8php_ad1bd0a7c70da186307de0136d0f0c2e3}{\$translator}}):\ void}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$this-\/>translator\ =\ \mbox{\hyperlink{discover-d234df6a22ae2b9b097ac6e3772bd950_8php_ad1bd0a7c70da186307de0136d0f0c2e3}{\$translator}};}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'strictMode'}]\ ??\ \textcolor{keyword}{true};}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'monthOverflow'}]\ ??\ \textcolor{keyword}{true};}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \$this-\/>\mbox{\hyperlink{namespace_carbon_1_1_traits_ae7b2b0de7f05bf6b6993996d7475804d}{getSettings}}()[\textcolor{stringliteral}{'yearOverflow'}]\ ??\ \textcolor{keyword}{true};}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ getWeekendDays():\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$this-\/>useTimezoneFromTestNow\ =\ (\mbox{\hyperlink{namespace_illuminate_1_1_console_1_1_scheduling_af1cceca0f6633f202e2e3eccb72912af}{\$timezone}}\ ===\ \textcolor{keyword}{null}\ \&\&\ \$testNow\ instanceof\ Closure);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!\$useDateInstanceTimezone)\ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{index_8php_ab7b0934f179386acaa4ad69fb6e3c8e6}{if}}\ (\$testNow\ instanceof\ Closure)\ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespace_illuminate_1_1_console_1_1_scheduling_af1cceca0f6633f202e2e3eccb72912af}{\$timezone}}\ ??=\ \$this-\/>useTimezoneFromTestNow\ ?\ \$testNow-\/>getTimezone()\ :\ \textcolor{keyword}{null};}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \$testNow\ =\ \$this-\/>\mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_ac565bd6a9d062c73a0a0db7afe0ffea9}{\_\_call}}(\textcolor{stringliteral}{'instance'},\ [\$testNow,\ \$timezone]);}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$factory\ =\ \mbox{\hyperlink{namespace_carbon_1_1_traits_a30fb1fe83217b873d8e474b88f258ae7}{clone}}\ \$this;}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$factory-\/>settings[\textcolor{stringliteral}{'timezone'}]\ =\ \mbox{\hyperlink{namespace_illuminate_1_1_console_1_1_scheduling_af1cceca0f6633f202e2e3eccb72912af}{\$timezone}};}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \$factory;}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{function}\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_ac565bd6a9d062c73a0a0db7afe0ffea9}{\_\_call}}(\textcolor{keywordtype}{string}\ \$name,\ array\ \$arguments):\ mixed}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{meta_8php_ab63db7036e979f887f1452188de1da61}{\$index}}\ =\ key(\$timezoneParameters);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!isset(\$arguments[\mbox{\hyperlink{meta_8php_ab63db7036e979f887f1452188de1da61}{\$index}}]))\ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$settings[\textcolor{stringliteral}{'translator'}]\ =\ \mbox{\hyperlink{discover-d234df6a22ae2b9b097ac6e3772bd950_8php_ad1bd0a7c70da186307de0136d0f0c2e3}{\$this-\/>translator}};}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \$previous\ =\ \mbox{\hyperlink{namespace_illuminate_1_1_http_a7b8c95284212c3072a7a96bd4233eb79}{\$exception}};}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{}
