\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/resolve.exports Directory Reference}
\hypertarget{dir_71b8c7486d7f15490957a39c043149b1}{}\label{dir_71b8c7486d7f15490957a39c043149b1}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/resolve.exports Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/resolve.exports Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{readme.md_autotoc_md6012}{}\doxysubsection{\texorpdfstring{resolve.\+exports \mbox{[}!\mbox{[}CI\mbox{]}(\href{https://github.com/lukeed/resolve.exports/workflows/CI/badge.svg}{\texttt{https\+://github.\+com/lukeed/resolve.\+exports/workflows/\+CI/badge.\+svg}})\mbox{]}(\href{https://github.com/lukeed/resolve.exports/actions}{\texttt{https\+://github.\+com/lukeed/resolve.\+exports/actions}}) \mbox{[}!\mbox{[}licenses\mbox{]}(\href{https://licenses.dev/b/npm/resolve.exports}{\texttt{https\+://licenses.\+dev/b/npm/resolve.\+exports}})\mbox{]}(\href{https://licenses.dev/npm/resolve.exports}{\texttt{https\+://licenses.\+dev/npm/resolve.\+exports}}) \mbox{[}!\mbox{[}codecov\mbox{]}(\href{https://codecov.io/gh/lukeed/resolve.exports/branch/master/graph/badge.svg?token=4P7d4Omw2h}{\texttt{https\+://codecov.\+io/gh/lukeed/resolve.\+exports/branch/master/graph/badge.\+svg?token=4\+P7d4\+Omw2h}})\mbox{]}(\href{https://codecov.io/gh/lukeed/resolve.exports}{\texttt{https\+://codecov.\+io/gh/lukeed/resolve.\+exports}})}{resolve.\+exports \mbox{[}!\mbox{[}CI\mbox{]}(\href{https://github.com/lukeed/resolve.exports/workflows/CI/badge.svg}{\texttt{https\+://github.\+com/lukeed/resolve.\+exports/workflows/\+CI/badge.\+svg}})\mbox{]}(\href{https://github.com/lukeed/resolve.exports/actions}{\texttt{https\+://github.\+com/lukeed/resolve.\+exports/actions}}) \mbox{[}!\mbox{[}licenses\mbox{]}(\href{https://licenses.dev/b/npm/resolve.exports}{\texttt{https\+://licenses.\+dev/b/npm/resolve.\+exports}})\mbox{]}(\href{https://licenses.dev/npm/resolve.exports}{\texttt{https\+://licenses.\+dev/npm/resolve.\+exports}}) \mbox{[}!\mbox{[}codecov\mbox{]}(\href{https://codecov.io/gh/lukeed/resolve.exports/branch/master/graph/badge.svg?token=4P7d4Omw2h}{\texttt{https\+://codecov.\+io/gh/lukeed/resolve.\+exports/branch/master/graph/badge.\+svg?token=4\+P7d4\+Omw2h}})\mbox{]}(\href{https://codecov.io/gh/lukeed/resolve.exports}{\texttt{https\+://codecov.\+io/gh/lukeed/resolve.\+exports}})}}\label{readme.md_autotoc_md6012}
\begin{quote}
...
Let\textquotesingle{}s have nice things.\hypertarget{readme.md_autotoc_md6013}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{readme.md_autotoc_md6013}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ resolve.exports}

\end{DoxyCode}
\hypertarget{readme.md_autotoc_md6014}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{readme.md_autotoc_md6014}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md6015}{}\doxysubsection{\texorpdfstring{API}{API}}\label{readme.md_autotoc_md6015}
...
\item may accept an Options object
...
\DoxyHorRuler{0}
\hypertarget{readme.md_autotoc_md6017}{}\doxysubsubsection{\texorpdfstring{resolve(pkg, entry?, options?)}{resolve(pkg, entry?, options?)}}\label{readme.md_autotoc_md6017}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md6018}{}\doxysubsubsection{\texorpdfstring{exports(pkg, entry?, options?)}{exports(pkg, entry?, options?)}}\label{readme.md_autotoc_md6018}
Returns\+: {\ttfamily string\mbox{[}\mbox{]}} or {\ttfamily undefined}
...
\end{DoxyItemize}\hypertarget{readme.md_autotoc_md6019}{}\doxysubsubsubsection{\texorpdfstring{pkg}{pkg}}\label{readme.md_autotoc_md6019}
Type\+: {\ttfamily object} ~\newline
 Required\+: {\ttfamily true}

The {\ttfamily package.\+json} contents.\hypertarget{readme.md_autotoc_md6020}{}\doxysubsubsubsection{\texorpdfstring{entry}{entry}}\label{readme.md_autotoc_md6020}
Type\+: {\ttfamily string} ~\newline
...
\end{longtabu}
\hypertarget{readme.md_autotoc_md6021}{}\doxysubsubsection{\texorpdfstring{imports(pkg, target, options?)}{imports(pkg, target, options?)}}\label{readme.md_autotoc_md6021}
Returns\+: {\ttfamily string\mbox{[}\mbox{]}} or {\ttfamily undefined}
...
\end{DoxyItemize}\hypertarget{readme.md_autotoc_md6022}{}\doxysubsubsubsection{\texorpdfstring{pkg}{pkg}}\label{readme.md_autotoc_md6022}
Type\+: {\ttfamily object} ~\newline
 Required\+: {\ttfamily true}

The {\ttfamily package.\+json} contents.\hypertarget{readme.md_autotoc_md6023}{}\doxysubsubsubsection{\texorpdfstring{target}{target}}\label{readme.md_autotoc_md6023}
Type\+: {\ttfamily string} ~\newline
 Required\+: {\ttfamily true}

The target import identifier; for example, {\ttfamily \#hash} or {\ttfamily \#hash/md5}.

Import specifiers {\itshape must} begin with the {\ttfamily \#} character, as required by the resolution specification. However, if {\ttfamily target} begins with the package name (determined by the {\ttfamily pkg.\+name} value), then {\ttfamily resolve.\+exports} will trim it from the {\ttfamily target} identifier. For example, {\ttfamily "{}foobar/\#hash/md5"{}} will be treated as {\ttfamily "{}\#hash/md5"{}} for the {\ttfamily "{}foobar"{}} package.\hypertarget{readme.md_autotoc_md6024}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{readme.md_autotoc_md6024}
...
\hypertarget{readme.md_autotoc_md6025}{}\doxysubsubsubsection{\texorpdfstring{options.\+require}{options.\+require}}\label{readme.md_autotoc_md6025}
Type\+: {\ttfamily boolean} ~\newline
 Default\+: {\ttfamily false}

When truthy, the {\ttfamily "{}require"{}} field is added to the list of allowed/known conditions. ~\newline
 Otherwise the {\ttfamily "{}import"{}} field is added instead.\hypertarget{readme.md_autotoc_md6026}{}\doxysubsubsubsection{\texorpdfstring{options.\+browser}{options.\+browser}}\label{readme.md_autotoc_md6026}
Type\+: {\ttfamily boolean} ~\newline
 Default\+: {\ttfamily false}

When truthy, the {\ttfamily "{}browser"{}} field is added to the list of allowed/known conditions. ~\newline
 Otherwise the {\ttfamily "{}node"{}} field is added instead.\hypertarget{readme.md_autotoc_md6027}{}\doxysubsubsubsection{\texorpdfstring{options.\+conditions}{options.\+conditions}}\label{readme.md_autotoc_md6027}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md6028}{}\doxysubsubsubsection{\texorpdfstring{options.\+unsafe}{options.\+unsafe}}\label{readme.md_autotoc_md6028}
Type\+: {\ttfamily boolean} ~\newline
 Default\+: {\ttfamily false}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md6029}{}\doxysubsection{\texorpdfstring{Legacy Resolver}{Legacy Resolver}}\label{readme.md_autotoc_md6029}
Also included is a "{}legacy"{} method for resolving non-\/{\ttfamily "{}exports"{}} package fields. This may be used as a fallback method when for when no {\ttfamily "{}exports"{}} mapping is defined. In other words, it\textquotesingle{}s completely optional (and tree-\/shakeable).\hypertarget{readme.md_autotoc_md6030}{}\doxysubsubsection{\texorpdfstring{legacy(pkg, options?)}{legacy(pkg, options?)}}\label{readme.md_autotoc_md6030}
...
When a field is found, its value is returned {\itshape as written}. ~\newline
 When no fields were found, {\ttfamily undefined} is returned. If you wish to mimic Node.\+js behavior, you can assume this means `\textquotesingle{}index.\+js'\`{} – but this module does not make that assumption for you.\hypertarget{readme.md_autotoc_md6031}{}\doxysubsubsubsection{\texorpdfstring{options.\+browser}{options.\+browser}}\label{readme.md_autotoc_md6031}
...
\end{quote}
\hypertarget{readme.md_autotoc_md6032}{}\doxysubsubsubsection{\texorpdfstring{options.\+fields}{options.\+fields}}\label{readme.md_autotoc_md6032}
Type\+: {\ttfamily string\mbox{[}\mbox{]}} ~\newline
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md6033}{}\doxysubsection{\texorpdfstring{License}{License}}\label{readme.md_autotoc_md6033}
