\doxysection{C\+:/xampp/htdocs/\+GPagos\+Ayuntamiento/node\+\_\+modules/diff-\/sequences Directory Reference}
\hypertarget{dir_5ede41af7a3990c0837044364c29c189}{}\label{dir_5ede41af7a3990c0837044364c29c189}\index{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/diff-\/sequences Directory Reference@{C:/xampp/htdocs/GPagosAyuntamiento/node\_modules/diff-\/sequences Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md2472}{}\doxysubsection{\texorpdfstring{diff-\/sequences}{diff-\/sequences}}\label{README.md_autotoc_md2472}
...
This package implements the {\bfseries{linear space}} variation with optimizations so it is fast even when sequences have {\bfseries{many}} differences.\hypertarget{README.md_autotoc_md2473}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md2473}
...
\begin{DoxyItemize}
\item `var diff = require(\textquotesingle{}diff-\/sequences').default; // Common\+JS modules{\ttfamily }
\item {\ttfamily }import diff from \textquotesingle{}diff-\/sequences\textquotesingle{}; // ECMAScript modules\`{}
\end{DoxyItemize}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2474}{}\doxysubsection{\texorpdfstring{Example of longest common subsequence}{Example of longest common subsequence}}\label{README.md_autotoc_md2474}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md2476}{}\doxysubsection{\texorpdfstring{Example of callback functions to find common items}{Example of callback functions to find common items}}\label{README.md_autotoc_md2476}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md2477}{}\doxysubsection{\texorpdfstring{Example of callback functions to diff index intervals}{Example of callback functions to diff index intervals}}\label{README.md_autotoc_md2477}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2478}{}\doxysubsection{\texorpdfstring{Example of callback functions to emulate diff command}{Example of callback functions to emulate diff command}}\label{README.md_autotoc_md2478}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2479}{}\doxysubsection{\texorpdfstring{Example of callback functions to format diff lines}{Example of callback functions to format diff lines}}\label{README.md_autotoc_md2479}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md2480}{}\doxysubsection{\texorpdfstring{Example of callback functions to find diff items}{Example of callback functions to find diff items}}\label{README.md_autotoc_md2480}
