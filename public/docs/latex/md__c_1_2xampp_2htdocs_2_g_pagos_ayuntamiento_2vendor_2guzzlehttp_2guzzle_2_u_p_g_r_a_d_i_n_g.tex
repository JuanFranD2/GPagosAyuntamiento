...
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g}{}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g}\index{Guzzle Upgrade Guide@{Guzzle Upgrade Guide}}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9205}{}\doxysection{\texorpdfstring{6.\+0 to 7.\+0}{6.\+0 to 7.\+0}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9205}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9206}{}\doxysubsubsection{\texorpdfstring{Other backwards compatibility breaking changes}{Other backwards compatibility breaking changes}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9206}
...
\item Function {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_cookie}{Cookie}\textbackslash{}Cookie\+Jar\+::get\+Cookie\+Value} is removed.
\item \doxylink{class_request}{Request} option {\ttfamily exceptions} is removed. Please use {\ttfamily http\+\_\+errors}.
\item \doxylink{class_request}{Request} option {\ttfamily save\+\_\+to} is removed. Please use {\ttfamily sink}.
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9207}{}\doxysubsubsection{\texorpdfstring{Native functions calls}{Native functions calls}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9207}
...
For the full diff you can check \href{https://github.com/guzzle/guzzle/compare/6.5.4..master}{\texttt{here}}.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9208}{}\doxysection{\texorpdfstring{5.\+0 to 6.\+0}{5.\+0 to 6.\+0}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9208}
Guzzle now uses \href{https://www.php-fig.org/psr/psr-7/}{\texttt{PSR-\/7}} for HTTP messages. Due to the fact that these messages are immutable, this prompted a refactoring of Guzzle to use a middleware based system rather than an event system. Any HTTP message interaction (e.\+g., {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Message\textbackslash{}\doxylink{class_request}{Request}}) need to be updated to work with the new immutable PSR-\/7 request and response objects. Any event listeners or subscribers need to be updated to become middleware functions that wrap handlers (or are injected into a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Handler\+Stack}).
...
\begin{DoxyItemize}
\item Removed the {\ttfamily \doxylink{class_event}{Event}} namespace.
...
\item {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Subscriber\textbackslash{}\doxylink{class_cookie}{Cookie}} is now provided by {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Middleware\+::cookies}
...
\item {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Subscriber\textbackslash{}\doxylink{class_redirect}{Redirect}} is now provided by {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Redirect\+Middleware}
\end{DoxyItemize}
\item Guzzle now uses {\ttfamily Psr\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Uri\+Interface} (implements in {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Psr7\textbackslash{}\doxylink{class_uri}{Uri}}) for URI support. {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Url} is now gone.
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9209}{}\doxysection{\texorpdfstring{Migrating to middleware}{Migrating to middleware}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9209}
...
\DoxyCodeLine{\$handler\ =\ \mbox{\hyperlink{class_guzzle_http_1_1_handler_stack_a16f15e9f8f4584c76741e861fc04d356}{GuzzleHttp\(\backslash\)HandlerStack::create}}();}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9210}{}\doxysection{\texorpdfstring{POST Requests}{POST Requests}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9210}
This version added the \href{https://docs.guzzlephp.org/en/latest/request-options.html\#form_params}{\texttt{{\ttfamily form\+\_\+params}}} and {\ttfamily multipart} request options. {\ttfamily form\+\_\+params} is an associative array of strings or array of strings and is used to serialize an {\ttfamily application/x-\/www-\/form-\/urlencoded} POST request. The \href{https://docs.guzzlephp.org/en/latest/request-options.html\#multipart}{\texttt{{\ttfamily multipart}}} option is now used to send a multipart/form-\/data POST request.
...
The {\ttfamily base\+\_\+url} option has been renamed to {\ttfamily base\+\_\+uri}.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9211}{}\doxysection{\texorpdfstring{4.\+x to 5.\+0}{4.\+x to 5.\+0}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9211}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9212}{}\doxysection{\texorpdfstring{Rewritten Adapter Layer}{Rewritten Adapter Layer}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9212}
Guzzle now uses \href{https://ringphp.readthedocs.org/en/latest}{\texttt{Ring\+PHP}} to send HTTP requests. The {\ttfamily adapter} option in a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Client} constructor is still supported, but it has now been renamed to {\ttfamily handler}. Instead of passing a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Adapter\textbackslash{}Adapter\+Interface}, you must now pass a PHP {\ttfamily callable} that follows the Ring\+PHP specification.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9213}{}\doxysection{\texorpdfstring{Removed Fluent Interfaces}{Removed Fluent Interfaces}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9213}
...
\item {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_cookie}{Cookie}\textbackslash{}Set\+Cookie}
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9214}{}\doxysection{\texorpdfstring{Removed functions.\+php}{Removed functions.\+php}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9214}
...
The "{}procedural"{} global client has been removed with no replacement (e.\+g., {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}get()}, {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}post()}, etc.). Use a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Client} object as a replacement.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9215}{}\doxysection{\texorpdfstring{{\ttfamily throw\+Immediately} has been removed}{{\ttfamily throw\+Immediately} has been removed}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9215}
The concept of "{}throw\+Immediately"{} has been removed from exceptions and error events. This control mechanism was used to stop a transfer of concurrent requests from completing. This can now be handled by throwing the exception or by cancelling a pool of requests or each outstanding future request individually.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9216}{}\doxysection{\texorpdfstring{headers event has been removed}{headers event has been removed}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9216}
Removed the "{}headers"{} event. This event was only useful for changing the body a response once the headers of the response were known. You can implement a similar behavior in a number of ways. One example might be to use a Fn\+Stream that has access to the transaction being sent. For example, when the first byte is written, you could check if the response headers match your expectations, and if so, change the actual stream body that is being written to.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9217}{}\doxysection{\texorpdfstring{Updates to HTTP Messages}{Updates to HTTP Messages}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9217}
Removed the {\ttfamily as\+Array} parameter from {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Message\textbackslash{}Message\+Interface\+::get\+Header}. If you want to get a header value as an array, then use the newly added {\ttfamily get\+Header\+As\+Array()} method of {\ttfamily Message\+Interface}. This change makes the Guzzle interfaces compatible with the PSR-\/7 interfaces.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9218}{}\doxysection{\texorpdfstring{3.\+x to 4.\+0}{3.\+x to 4.\+0}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9218}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9219}{}\doxysection{\texorpdfstring{Overarching changes\+:}{Overarching changes\+:}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9219}
...
\item No longer requiring the Symfony Event\+Dispatcher. A custom event dispatcher based on the Symfony Event\+Dispatcher is now utilized in {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Emitter\+Interface} (resulting in significant speed and functionality improvements).
\end{DoxyItemize}

Changes per Guzzle 3.\+x namespace are described below.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9220}{}\doxysection{\texorpdfstring{Batch}{Batch}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9220}
The {\ttfamily Guzzle\textbackslash{}Batch} namespace has been removed. This is best left to third-\/parties to implement on top of Guzzle\textquotesingle{}s core HTTP library.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9221}{}\doxysection{\texorpdfstring{Cache}{Cache}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9221}
The {\ttfamily Guzzle\textbackslash{}\doxylink{class_cache}{Cache}} namespace has been removed. (Todo\+: No suitable replacement has been implemented yet, but hoping to utilize a PSR cache interface).\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9222}{}\doxysection{\texorpdfstring{Common}{Common}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9222}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9223}{}\doxysubsection{\texorpdfstring{Collection}{Collection}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9223}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9224}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9224}
Guzzle no longer requires Symfony\textquotesingle{}s Event\+Dispatcher component. Guzzle now uses {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Emitter}.


\begin{DoxyItemize}
\item {\ttfamily Symfony\textbackslash{}\doxylink{class_component}{Component}\textbackslash{}Event\+Dispatcher\textbackslash{}Event\+Dispatcher\+Interface} is replaced by {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Emitter\+Interface}.
\item {\ttfamily Symfony\textbackslash{}\doxylink{class_component}{Component}\textbackslash{}Event\+Dispatcher\textbackslash{}Event\+Dispatcher} is replaced by {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Emitter}.
\item {\ttfamily Symfony\textbackslash{}\doxylink{class_component}{Component}\textbackslash{}Event\+Dispatcher\textbackslash{}\doxylink{class_event}{Event}} is replaced by {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}\doxylink{class_event}{Event}}, and Guzzle now has an Event\+Interface in {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Event\+Interface}.
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9225}{}\doxysubsubsection{\texorpdfstring{Emitter}{Emitter}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9225}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9226}{}\doxysection{\texorpdfstring{Http}{Http}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9226}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9227}{}\doxysubsection{\texorpdfstring{General changes}{General changes}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9227}
...
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Url} has moved to {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Url}.
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Query\+String} has moved to {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Query}.
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9228}{}\doxysubsection{\texorpdfstring{Client}{Client}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9228}
...
\DoxyCodeLine{\$response\ =\ \$request-\/>send();}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ 4.0}}
\DoxyCodeLine{\$response\ =\ \$client-\/>get(\textcolor{charliteral}{'/'});}
\DoxyCodeLine{}
...
\DoxyCodeLine{\$response\ =\ \$client-\/>send(\$request);}
...
\item {\ttfamily set\+User\+Agent()} has been removed. Use a default request option instead. You could, for example, do something like\+: `\$client-\/\texorpdfstring{$>$}{>}set\+Config(\textquotesingle{}defaults/headers/\+User-\/\+Agent', \textquotesingle{}Foo/\+Bar \textquotesingle{} . \$client\+::get\+Default\+User\+Agent()){\ttfamily .}
\item {\ttfamily }set\+Ssl\+Verification(){\ttfamily  has been removed. Use default request options instead, like }\$client-\/\texorpdfstring{$>$}{>}set\+Config(\textquotesingle{}defaults/verify\textquotesingle{}, true)\`{}.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item The constructor now accepts only an associative array. You can include a {\ttfamily base\+\_\+url} string or array to use a URI template as the base \doxylink{class_u_r_l}{URL} of a client. You can also specify a {\ttfamily defaults} key that is an associative array of default request options. You can pass an {\ttfamily adapter} to use a custom adapter, {\ttfamily batch\+\_\+adapter} to use a custom adapter for sending requests in parallel, or a {\ttfamily message\+\_\+factory} to change the factory used to create HTTP requests and responses.
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9229}{}\doxysubsection{\texorpdfstring{Messages}{Messages}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9229}
Messages no longer have references to their counterparts (i.\+e., a request no longer has a reference to it\textquotesingle{}s response, and a response no loger has a reference to its request). This association is now managed through a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Adapter\textbackslash{}Transaction\+Interface} object. You can get references to these transaction objects using request events that are emitted over the lifecycle of a request.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9230}{}\doxysubsubsection{\texorpdfstring{Requests with a body}{Requests with a body}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9230}
...
\item Any method that previously accepts a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_response}{Response}} object now accept a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Message\textbackslash{}Response\+Interface}.
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9231}{}\doxysubsubsection{\texorpdfstring{Headers}{Headers}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9231}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9232}{}\doxysubsubsection{\texorpdfstring{Responses}{Responses}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9232}
...
\item Header specific helper functions like {\ttfamily get\+Content\+Md5()} have been removed. Just use `get\+Header(\textquotesingle{}Content-\/\+MD5'){\ttfamily  instead.}
\item {\ttfamily }\doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\+Message\textbackslash{}\+Response\+::set\+Request(){\ttfamily  and }\doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\+Message\textbackslash{}\+Response\+::get\+Request(){\ttfamily  have been removed. Use the event system to work with request and response objects as a transaction.}
\item {\ttfamily }\doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\+Message\textbackslash{}\+Response\+::get\+Redirect\+Count(){\ttfamily  has been removed. Use the \doxylink{class_redirect}{Redirect} subscriber instead.}
\item {\ttfamily }\doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\+Message\textbackslash{}\+Response\+::is\+Successful(){\ttfamily  and other related methods have been removed. Use }get\+Status\+Code()\`{} instead.
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9233}{}\doxysubsubsection{\texorpdfstring{Streaming responses}{Streaming responses}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9233}
...
\DoxyCodeLine{\$data\ =\ \$stream-\/>read(1024);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ 4.0}}
\DoxyCodeLine{\$response\ =\ \$client-\/>get(\textcolor{charliteral}{'/'},\ [\textcolor{stringliteral}{'stream'}\ =>\ \textcolor{keyword}{true}]);}
\DoxyCodeLine{\textcolor{comment}{//\ Read\ some\ data\ off\ of\ the\ stream\ in\ the\ response\ body}}
\DoxyCodeLine{\$data\ =\ \$response-\/>getBody()-\/>read(1024);}

\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9234}{}\doxysubsubsection{\texorpdfstring{Redirects}{Redirects}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9234}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9235}{}\doxysubsubsection{\texorpdfstring{Entity\+Body}{Entity\+Body}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9235}
...
\begin{DoxyItemize}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Entity\+Body\+Interface} is now {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Stream\textbackslash{}Stream\+Interface}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Entity\+Body} is now {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Stream\textbackslash{}Stream}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Caching\+Entity\+Body} is now {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Stream\textbackslash{}Caching\+Stream}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Read\+Limit\+Entity\+Body} is now {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Stream\textbackslash{}Limit\+Stream}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Io\+Emittyin\+Entity\+Body} has been removed.
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9236}{}\doxysubsubsection{\texorpdfstring{Request lifecycle events}{Request lifecycle events}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9236}
Requests previously submitted a large number of requests. The number of events emitted over the lifecycle of a request has been significantly reduced to make it easier to understand how to extend the behavior of a request. All events emitted during the lifecycle of a request now emit a custom {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Event\+Interface} object that contains context providing methods and a way in which to modify the transaction at that specific point in time (e.\+g., intercept the request and set a response on the transaction).


\begin{DoxyItemize}
\item {\ttfamily request.\+before\+\_\+send} has been renamed to {\ttfamily before} and now emits a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Before\+Event}
\item {\ttfamily request.\+complete} has been renamed to {\ttfamily complete} and now emits a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Complete\+Event}.
...
\item {\ttfamily error} is now an event that emits a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Error\+Event}.
...
{\ttfamily headers} is a new event that is emitted after the response headers of a request have been received before the body of the response is downloaded. This event emits a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Headers\+Event}.

You can intercept a request and inject a response using the {\ttfamily intercept()} event of a {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Before\+Event}, {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Complete\+Event}, and {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_event}{Event}\textbackslash{}Error\+Event} event.

See\+: \href{https://docs.guzzlephp.org/en/latest/events.html}{\texttt{https\+://docs.\+guzzlephp.\+org/en/latest/events.\+html}}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9237}{}\doxysection{\texorpdfstring{Inflection}{Inflection}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9237}
The {\ttfamily Guzzle\textbackslash{}Inflection} namespace has been removed. This is not a core concern of Guzzle.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9238}{}\doxysection{\texorpdfstring{Iterator}{Iterator}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9238}
...
For a replacement of these iterators, see \href{https://github.com/nikic/iter}{\texttt{https\+://github.\+com/nikic/iter}}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9239}{}\doxysection{\texorpdfstring{Log}{Log}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9239}
The Log\+Plugin has moved to \href{https://github.com/guzzle/log-subscriber}{\texttt{https\+://github.\+com/guzzle/log-\/subscriber}}. The {\ttfamily Guzzle\textbackslash{}\doxylink{class_log}{Log}} namespace has been removed. Guzzle now relies on {\ttfamily Psr\textbackslash{}\doxylink{class_log}{Log}\textbackslash{}Logger\+Interface} for all logging. The Message\+Formatter class has been moved to {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Subscriber\textbackslash{}\doxylink{class_log}{Log}\textbackslash{}Formatter}.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9240}{}\doxysection{\texorpdfstring{Parser}{Parser}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9240}
...
\begin{DoxyItemize}
\item \doxylink{class_cookie}{Cookie}\+: \doxylink{class_cookie}{Cookie} parsing logic has been moved to {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_cookie}{Cookie}\textbackslash{}Set\+Cookie\+::from\+String}.
...
\item Url\+: \doxylink{class_u_r_l}{URL} parsing is now performed in {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Url\+::from\+String} (previously it was {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Url\+::factory()}). If custom \doxylink{class_u_r_l}{URL} parsing is necessary, then developers are free to subclass {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Url}.
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9241}{}\doxysection{\texorpdfstring{Plugin}{Plugin}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9241}
...
\begin{DoxyItemize}
\item {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Subscriber\textbackslash{}\doxylink{class_cookie}{Cookie}}\+: Replaces the old Cookie\+Plugin. \doxylink{class_cookie}{Cookie} jar code has moved to {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}\doxylink{class_cookie}{Cookie}}.
...
\item {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Subscriber\textbackslash{}\doxylink{class_redirect}{Redirect}}\+: Replaces the Redirect\+Plugin.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Plugin\textbackslash{}Backoff\+Plugin} has been rewritten to be much simpler to build custom retry policies using simple functions rather than various chained classes. See\+: \href{https://github.com/guzzle/retry-subscriber}{\texttt{https\+://github.\+com/guzzle/retry-\/subscriber}}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Plugin\textbackslash{}\doxylink{class_cache}{Cache}\textbackslash{}Cache\+Plugin} has moved to \href{https://github.com/guzzle/cache-subscriber}{\texttt{https\+://github.\+com/guzzle/cache-\/subscriber}}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Plugin\textbackslash{}\doxylink{class_log}{Log}\textbackslash{}Log\+Plugin} has moved to \href{https://github.com/guzzle/log-subscriber}{\texttt{https\+://github.\+com/guzzle/log-\/subscriber}}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Plugin\textbackslash{}Md5\textbackslash{}Md5\+Plugin} has moved to \href{https://github.com/guzzle/message-integrity-subscriber}{\texttt{https\+://github.\+com/guzzle/message-\/integrity-\/subscriber}}
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Plugin\textbackslash{}Mock\textbackslash{}Mock\+Plugin} has moved to {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Subscriber\textbackslash{}Mock\+Subscriber}.
\item {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Plugin\textbackslash{}Oauth\textbackslash{}Oauth\+Plugin} has moved to \href{https://github.com/guzzle/oauth-subscriber}{\texttt{https\+://github.\+com/guzzle/oauth-\/subscriber}}
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9242}{}\doxysection{\texorpdfstring{Service}{Service}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9242}
The service description layer of Guzzle has moved into two separate packages\+:


\begin{DoxyItemize}
\item \href{https://github.com/guzzle/command}{\texttt{https\+://github.\+com/guzzle/command}} Provides a high level abstraction over web services by representing web service operations using commands.
\item \href{https://github.com/guzzle/guzzle-services}{\texttt{https\+://github.\+com/guzzle/guzzle-\/services}} Provides an implementation of guzzle/command that provides request serialization and response parsing using Guzzle service descriptions.
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9243}{}\doxysection{\texorpdfstring{Stream}{Stream}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9243}
...
{\ttfamily Guzzle\textbackslash{}Stream\textbackslash{}Stream\+Interface} has been given a large update to cleanly take on the responsibilities of {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Entity\+Body} and {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Entity\+Body\+Interface} now that they have been removed. The number of methods implemented by the {\ttfamily Stream\+Interface} has been drastically reduced to allow developers to more easily extend and decorate stream behavior.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9244}{}\doxysection{\texorpdfstring{Removed methods from Stream\+Interface}{Removed methods from Stream\+Interface}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9244}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9245}{}\doxysection{\texorpdfstring{Renamed methods}{Renamed methods}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9245}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9246}{}\doxysection{\texorpdfstring{Metadata streams}{Metadata streams}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9246}
{\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Stream\textbackslash{}Metadata\+Stream\+Interface} has been added to denote streams that contain additional metadata accessible via {\ttfamily get\+Metadata()}. {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Stream\textbackslash{}Stream\+Interface\+::get\+Metadata} and {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Stream\textbackslash{}Stream\+Interface\+::set\+Metadata} have been removed.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9247}{}\doxysection{\texorpdfstring{Stream\+Request\+Factory}{Stream\+Request\+Factory}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9247}
The entire concept of the Stream\+Request\+Factory has been removed. The way this was used in Guzzle 3 broke the actual interface of sending streaming requests (instead of getting back a \doxylink{class_response}{Response}, you got a Stream\+Interface). Streaming PHP requests are now implemented through the {\ttfamily \doxylink{namespace_guzzle_http}{Guzzle\+Http}\textbackslash{}Adapter\textbackslash{}Stream\+Adapter}.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9248}{}\doxysection{\texorpdfstring{3.\+6 to 3.\+7}{3.\+6 to 3.\+7}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9248}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9249}{}\doxysubsection{\texorpdfstring{Deprecations}{Deprecations}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9249}
...
\begin{DoxyItemize}
\item Marked {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Request\+::is\+Response\+Body\+Repeatable()} as deprecated. Use {\ttfamily \$request-\/\texorpdfstring{$>$}{>}get\+Response\+Body()-\/\texorpdfstring{$>$}{>}is\+Repeatable()} instead.
\item Marked {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Request\+::can\+Cache()} as deprecated. Use {\ttfamily Guzzle\textbackslash{}Plugin\textbackslash{}\doxylink{class_cache}{Cache}\textbackslash{}Default\+Can\+Cache\+Strategy-\/\texorpdfstring{$>$}{>}can\+Cache\+Request()} instead.
\item Marked {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Request\+::can\+Cache()} as deprecated. Use {\ttfamily Guzzle\textbackslash{}Plugin\textbackslash{}\doxylink{class_cache}{Cache}\textbackslash{}Default\+Can\+Cache\+Strategy-\/\texorpdfstring{$>$}{>}can\+Cache\+Request()} instead.
\item Marked {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Request\+::set\+Is\+Redirect()} as deprecated. Use the History\+Plugin instead.
\item Marked {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Request\+::is\+Redirect()} as deprecated. Use the History\+Plugin instead.
\item Marked {\ttfamily Guzzle\textbackslash{}\doxylink{class_cache}{Cache}\textbackslash{}Cache\+Adapter\+Factory\+::factory()} as deprecated
...
\item Marked \textquotesingle{}request.\+params' for {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Client} as deprecated. Use `\$client-\/\texorpdfstring{$>$}{>}set\+Default\+Option(\textquotesingle{}params/\{param\+\_\+name\}', \textquotesingle{}value\textquotesingle{})`
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9250}{}\doxysubsection{\texorpdfstring{Interface changes}{Interface changes}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9250}
Additions and changes (you will need to update any implementations or subclasses you may have created)\+:


\begin{DoxyItemize}
\item Added an {\ttfamily \$options} argument to the end of the following methods of {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Client\+Interface}\+: create\+Request, head, delete, put, patch, post, options, prepare\+Request
\item Added an {\ttfamily \$options} argument to the end of {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}\doxylink{class_request}{Request}\textbackslash{}Request\+Factory\+Interface\+::create\+Request()}
\item Added an {\ttfamily apply\+Options()} method to {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}\doxylink{class_request}{Request}\textbackslash{}Request\+Factory\+Interface}
\item Changed {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Client\+Interface\+::get(\$uri = null, \$headers = null, \$body = null)} to {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Client\+Interface\+::get(\$uri = null, \$headers = null, \$options = array())}. You can still pass in a resource, string, or Entity\+Body into the \$options parameter to specify the download location of the response.
...
\item Made {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Client\+::expand\+Template} and {\ttfamily get\+Uri\+Template} protected methods.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Removed {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Client\+Interface\+::set\+Default\+Headers(). Use }\$client-\/\texorpdfstring{$>$}{>}get\+Config()-\/\texorpdfstring{$>$}{>}set\+Path(\textquotesingle{}request.\+options/headers/\{header\+\_\+name\}\textquotesingle{}, \textquotesingle{}value\textquotesingle{}){\ttfamily . or }\$client-\/\texorpdfstring{$>$}{>}get\+Config()-\/\texorpdfstring{$>$}{>}set\+Path(\textquotesingle{}request.\+options/headers\textquotesingle{}, array(\textquotesingle{}header\+\_\+name\textquotesingle{} =\texorpdfstring{$>$}{>} \textquotesingle{}value\textquotesingle{})){\ttfamily  or }\$client-\/\texorpdfstring{$>$}{>}set\+Default\+Option(\textquotesingle{}headers/\{header\+\_\+name\}\textquotesingle{}, \textquotesingle{}value\textquotesingle{}){\ttfamily . or }\$client-\/\texorpdfstring{$>$}{>}set\+Default\+Option(\textquotesingle{}headers\textquotesingle{}, array(\textquotesingle{}header\+\_\+name\textquotesingle{} =\texorpdfstring{$>$}{>} \textquotesingle{}value\textquotesingle{})){\ttfamily .}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9251}{}\doxysubsection{\texorpdfstring{Cache plugin breaking changes}{Cache plugin breaking changes}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9251}
...
\item {\ttfamily Cache\+Storage\+Interface\+::cache(\$key, \doxylink{class_response}{Response} \$response, \$ttl = null)} has changed to {\ttfamily cache(Request\+Interface \$request, \doxylink{class_response}{Response} \$response);}
...
\item Added {\ttfamily Revalidation\+Interface\+::should\+Revalidate(Request\+Interface \$request, \doxylink{class_response}{Response} \$response)}
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9252}{}\doxysection{\texorpdfstring{3.\+5 to 3.\+6}{3.\+5 to 3.\+6}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9252}
...
\item Removed the whole changed\+Header() function system of messages because all header changes now go through add\+Header(). For example, set\+Header() first removes the header using unset on a Header\+Collection and then calls add\+Header(). Keeping the Host header and \doxylink{class_u_r_l}{URL} host in sync is now handled by overriding the add\+Header method in \doxylink{class_request}{Request}.
...
\item Moved get\+Links() from \doxylink{class_response}{Response} to just be used on a Link header object.
\end{DoxyItemize}

If you previously relied on Guzzle\textbackslash{}\+Http\textbackslash{}\+Message\textbackslash{}\+Header\+::raw(), then you will need to update your code to use the Header\+Interface (e.\+g. to\+Array(), get\+All(), etc.).\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9253}{}\doxysubsection{\texorpdfstring{Interface changes}{Interface changes}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9253}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9254}{}\doxysubsection{\texorpdfstring{Removed deprecated functions}{Removed deprecated functions}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9254}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9255}{}\doxysubsection{\texorpdfstring{Deprecations}{Deprecations}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9255}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9256}{}\doxysubsection{\texorpdfstring{Other changes}{Other changes}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9256}
...
\end{DoxyItemize}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9257}{}\doxysection{\texorpdfstring{3.\+3 to 3.\+4}{3.\+3 to 3.\+4}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9257}
Base URLs of a client now follow the rules of \href{https://datatracker.ietf.org/doc/html/rfc3986\#section-5.2.2}{\texttt{https\+://datatracker.\+ietf.\+org/doc/html/rfc3986\#section-\/5.\+2.\+2}} when merging URLs.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9258}{}\doxysection{\texorpdfstring{3.\+2 to 3.\+3}{3.\+2 to 3.\+3}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9258}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9259}{}\doxysubsection{\texorpdfstring{Response\+::get\+Etag() quote stripping removed}{Response\+::get\+Etag() quote stripping removed}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9259}
{\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Message\textbackslash{}Response\+::get\+Etag()} no longer strips quotes around the ETag response header\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9260}{}\doxysubsection{\texorpdfstring{Removed {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Utils}}{Removed {\ttfamily Guzzle\textbackslash{}Http\textbackslash{}Utils}}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9260}
The {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Utils} class was removed. This class was only used for testing.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9261}{}\doxysubsection{\texorpdfstring{Stream wrapper and type}{Stream wrapper and type}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9261}
{\ttfamily Guzzle\textbackslash{}Stream\textbackslash{}Stream\+::get\+Wrapper()} and {\ttfamily Guzzle\textbackslash{}Stream\textbackslash{}Stream\+::get\+Stream\+Type()} are no longer converted to lowercase.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9262}{}\doxysubsection{\texorpdfstring{curl.\+emit\+\_\+io became emit\+\_\+io}{curl.\+emit\+\_\+io became emit\+\_\+io}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9262}
Emitting IO events from a Request\+Mediator is now a parameter that must be set in a request\textquotesingle{}s curl options using the \textquotesingle{}emit\+\_\+io\textquotesingle{} key. This was previously set under a request\textquotesingle{}s parameters using \textquotesingle{}curl.\+emit\+\_\+io\textquotesingle{}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9263}{}\doxysection{\texorpdfstring{3.\+1 to 3.\+2}{3.\+1 to 3.\+2}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9263}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9264}{}\doxysubsection{\texorpdfstring{Curl\+Multi is no longer reused globally}{Curl\+Multi is no longer reused globally}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9264}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9265}{}\doxysubsection{\texorpdfstring{No default path}{No default path}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9265}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9266}{}\doxysubsection{\texorpdfstring{Less verbose Bad\+Response\+Exception}{Less verbose Bad\+Response\+Exception}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9266}
The exception message for {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Exception\textbackslash{}Bad\+Response\+Exception} no longer contains the full HTTP request and response information. You can, however, get access to the request and response object by calling {\ttfamily get\+Request()} or {\ttfamily get\+Response()} on the exception object.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9267}{}\doxysubsection{\texorpdfstring{Query parameter aggregation}{Query parameter aggregation}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9267}
Multi-\/valued query parameters are no longer aggregated using a callback function. {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Query} now has a set\+Aggregator() method that accepts a {\ttfamily Guzzle\textbackslash{}\doxylink{class_http}{Http}\textbackslash{}Query\+Aggregator\textbackslash{}Query\+Aggregator\+Interface} object. This object is responsible for handling the aggregation of multi-\/valued query string variables into a flattened hash.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9268}{}\doxysection{\texorpdfstring{2.\+8 to 3.\+x}{2.\+8 to 3.\+x}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9268}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9269}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Service\textbackslash{}\+Inspector}{Guzzle\textbackslash{}\+Service\textbackslash{}\+Inspector}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9269}
...
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}\ \textcolor{keyword}{static}\ \textcolor{keyword}{function}\ factory(\mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}\ =\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}())}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{translations_8php_a9df479534ecf05fd7575c6275d381687}{\$default}}\ =\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}();}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$required\ =\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}(\textcolor{stringliteral}{'base\_url'},\ \textcolor{stringliteral}{'username'},\ \textcolor{stringliteral}{'api\_key'});}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}\ =\ Inspector::fromConfig(\mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}},\ \mbox{\hyperlink{translations_8php_a9df479534ecf05fd7575c6275d381687}{\$default}},\ \$required);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$client\ =\ \textcolor{keyword}{new}\ \textcolor{keyword}{self}(}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}-\/>get(\textcolor{stringliteral}{'base\_url'}),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}-\/>get(\textcolor{stringliteral}{'username'}),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}-\/>get(\textcolor{stringliteral}{'api\_key'})}
\DoxyCodeLine{\ \ \ \ \ \ \ \ );}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$client-\/>setConfig(\mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{translations_8php_a9df479534ecf05fd7575c6275d381687}{\$default}}\ =\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}();}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$required\ =\ \mbox{\hyperlink{namespace_illuminate_1_1_support_1_1_traits_a141d5fb858fa6c89a703e21717c1bb4b}{array}}(\textcolor{stringliteral}{'base\_url'},\ \textcolor{stringliteral}{'username'},\ \textcolor{stringliteral}{'api\_key'});}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}\ =\ Collection::fromConfig(\mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}},\ \mbox{\hyperlink{translations_8php_a9df479534ecf05fd7575c6275d381687}{\$default}},\ \$required);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \$client\ =\ \textcolor{keyword}{new}\ \textcolor{keyword}{self}(}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}-\/>get(\textcolor{stringliteral}{'base\_url'}),}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{barryvdh_2laravel-ide-helper_2_8php-cs-fixer_8dist_8php_a49c7011be9c979d9174c52a8b83e5d8e}{\$config}}-\/>get(\textcolor{stringliteral}{'username'}),}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9270}{}\doxysubsection{\texorpdfstring{Convert XML Service Descriptions to JSON}{Convert XML Service Descriptions to JSON}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9270}
{\bfseries{Before}}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9271}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Service\textbackslash{}\+Description\textbackslash{}\+Service\+Description}{Guzzle\textbackslash{}\+Service\textbackslash{}\+Description\textbackslash{}\+Service\+Description}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9271}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9272}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Common\textbackslash{}\+Inflection\textbackslash{}\+Inflector}{Guzzle\textbackslash{}\+Common\textbackslash{}\+Inflection\textbackslash{}\+Inflector}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9272}
Namespace is now {\ttfamily Guzzle\textbackslash{}Inflection\textbackslash{}Inflector}\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9273}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9273}
Namespace is now {\ttfamily Guzzle\textbackslash{}Plugin}. Many other changes occur within this namespace and are detailed in their own sections below.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9274}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Log\+Plugin and Guzzle\textbackslash{}\+Common\textbackslash{}\+Log}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Log\+Plugin and Guzzle\textbackslash{}\+Common\textbackslash{}\+Log}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9274}
Now {\ttfamily Guzzle\textbackslash{}Plugin\textbackslash{}\doxylink{class_log}{Log}\textbackslash{}Log\+Plugin} and {\ttfamily Guzzle\textbackslash{}\doxylink{class_log}{Log}} respectively.
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9275}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Curl\+Auth\+Plugin}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Curl\+Auth\+Plugin}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9275}
Now {\ttfamily Guzzle\textbackslash{}Plugin\textbackslash{}Curl\+Auth\textbackslash{}Curl\+Auth\+Plugin}.\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9276}{}\doxysubsection{\texorpdfstring{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Exponential\+Backoff\+Plugin}{Guzzle\textbackslash{}\+Http\textbackslash{}\+Plugin\textbackslash{}\+Exponential\+Backoff\+Plugin}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9276}
...
\end{DoxyCode}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9277}{}\doxysubsection{\texorpdfstring{Known Issues}{Known Issues}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9277}
\hypertarget{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9278}{}\doxysubsubsection{\texorpdfstring{\mbox{[}BUG\mbox{]} Accept-\/\+Encoding header behavior changed unintentionally.}{\mbox{[}BUG\mbox{]} Accept-\/\+Encoding header behavior changed unintentionally.}}\label{md__c_1_2xampp_2htdocs_2_g_pagos_ayuntamiento_2vendor_2guzzlehttp_2guzzle_2_u_p_g_r_a_d_i_n_g_autotoc_md9278}
